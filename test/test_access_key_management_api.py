...
from sumologic_client.api.access_key_management_api import AccessKeyManagementApi  # noqa: E501


class TestAccessKeyManagementApi(unittest.TestCase):
    """AccessKeyManagementApi unit test stubs"""

    def setUp(self):
        self.api = AccessKeyManagementApi()  # noqa: E501
    ...
    def test_list_personal_access_keys(self):
        """Test case for list_personal_access_keys
