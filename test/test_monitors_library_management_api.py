...
from sumologic_client.api.monitors_library_management_api import MonitorsLibraryManagementApi  # noqa: E501


class TestMonitorsLibraryManagementApi(unittest.TestCase):
    """MonitorsLibraryManagementApi unit test stubs"""

    def setUp(self):
        self.api = MonitorsLibraryManagementApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_disable_monitor_by_ids(self):
        """Test case for disable_monitor_by_ids

        Disable monitors.  # noqa: E501
        """
        pass

    def test_get_monitor_usage_info(self):
        """Test case for get_monitor_usage_info

        Usage info of monitors.  # noqa: E501
        """
        pass

    def test_get_monitors_full_path(self):
        """Test case for get_monitors_full_path

        Get the path of a monitor or folder.  # noqa: E501
        """
        pass

    def test_get_monitors_library_root(self):
        """Test case for get_monitors_library_root

        Get the root monitors folder.  # noqa: E501
        """
        pass

    def test_monitors_copy(self):
        """Test case for monitors_copy

        Copy a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_create(self):
        """Test case for monitors_create

        Create a monitor or folder.   # noqa: E501
        """
        pass

    def test_monitors_delete_by_id(self):
        """Test case for monitors_delete_by_id

        Delete a monitor or folder.   # noqa: E501
        """
        pass

    def test_monitors_delete_by_ids(self):
        """Test case for monitors_delete_by_ids

        Bulk delete a monitor or folder.   # noqa: E501
        """
        pass

    def test_monitors_export_item(self):
        """Test case for monitors_export_item

        Export a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_get_by_path(self):
        """Test case for monitors_get_by_path

        Read a monitor or folder by its path.  # noqa: E501
        """
        pass

    def test_monitors_import_item(self):
        """Test case for monitors_import_item

        Import a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_move(self):
        """Test case for monitors_move

        Move a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_read_by_id(self):
        """Test case for monitors_read_by_id

        Get a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_read_by_ids(self):
        """Test case for monitors_read_by_ids

        Bulk read a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_search(self):
        """Test case for monitors_search

        Search for a monitor or folder.  # noqa: E501
        """
        pass

    def test_monitors_update_by_id(self):
        """Test case for monitors_update_by_id
