    ...
    def __init__(self, api_client=None):
        ...
        def __get_app(
            ...
            **kwargs
            ...
            """Get an app by UUID.  # noqa: E501

            Gets the app with the given universally unique identifier (UUID).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_app(uuid, async_req=True)
            >>> result = thread.get()
        ...
        def __get_async_install_status(
            self,
            job_id,
            **kwargs
        ):
            """App install job status.  # noqa: E501

            Get the status of an asynchronous app install request for the given job identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_async_install_status(job_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_async_install_status = _Endpoint(
            settings={
                'response_type': (AsyncJobStatus,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/apps/install/{jobId}/status',
                'operation_id': 'get_async_install_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_async_install_status
        )
        ...
        def __install_app(
            ...
            **kwargs
            ...
            """Install an app by UUID.  # noqa: E501

            Installs the app with given UUID in the folder specified using destinationFolderId.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.install_app(uuid, app_install_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['uuid'] = \
                uuid
            kwargs['app_install_request'] = \
                app_install_request
            return self.call_with_http_info(**kwargs)

        self.install_app = _Endpoint(
            settings={
                'response_type': (BeginAsyncJobResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/apps/{uuid}/install',
        ...
        def __list_apps(
            ...
            **kwargs
            ...
            """List available apps.  # noqa: E501

            Lists all available apps from the App Catalog.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.list_apps = _Endpoint(
            settings={
                'response_type': (ListAppsResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/apps',
