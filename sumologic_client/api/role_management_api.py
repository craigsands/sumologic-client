...
class RoleManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.assign_role_to_user = _Endpoint(
            settings={
                'response_type': (RoleModel,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/roles/{roleId}/users/{userId}',
            ...
            callable=__assign_role_to_user
        )
        ...
        def __create_role(
            ...
            **kwargs
            ...
            >>> thread = api.create_role(create_role_definition, async_req=True)
            >>> result = thread.get()

            Args:
                create_role_definition (CreateRoleDefinition): Information about the new role.
        ...
        self.list_roles = _Endpoint(
            settings={
                'response_type': (ListRoleModelsResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/roles',
        ...
        self.remove_role_from_user = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
            ...
            api_client=api_client,
            callable=__remove_role_from_user
        )
        ...
        def __update_role(
            ...
            **kwargs
            ...
            >>> thread = api.update_role(id, update_role_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the role to update.
                update_role_definition (UpdateRoleDefinition): Information to update about the role.
