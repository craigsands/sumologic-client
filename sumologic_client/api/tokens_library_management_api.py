...
class TokensLibraryManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_token(
            self,
            token_base_definition,
            **kwargs
        ):
            """Create a token.  # noqa: E501

            Create a token in the token library.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_token(token_base_definition, async_req=True)
            >>> result = thread.get()

            Args:
                token_base_definition (TokenBaseDefinition): Information about the token to create.
            ...
            kwargs['token_base_definition'] = \
                token_base_definition
            return self.call_with_http_info(**kwargs)

        self.create_token = _Endpoint(
            settings={
                'response_type': (TokenBaseResponse,),
                'auth': [
                    'basicAuth'
                ],
        ...
        def __delete_token(
            ...
            **kwargs
            ...
            Delete a token with the given identifier in the token library.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __get_token(
            ...
            **kwargs
            ...
            Get a token with the given identifier in the token library.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __list_tokens(
            ...
            **kwargs
            ...
            """Get a list of tokens.  # noqa: E501

            Get a list of all tokens in the token library.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.list_tokens = _Endpoint(
            settings={
                'response_type': (ListTokensBaseResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/tokens',
        ...
        def __update_token(
            self,
            id,
            token_base_definition_update,
            **kwargs
        ):
            """Update a token.  # noqa: E501

            Update a token with the given identifier in the token library.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_token(id, token_base_definition_update, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the token to update.
                token_base_definition_update (TokenBaseDefinitionUpdate): The token to update.
            ...
            kwargs['id'] = \
                id
            kwargs['token_base_definition_update'] = \
                token_base_definition_update
            return self.call_with_http_info(**kwargs)

        self.update_token = _Endpoint(
            settings={
                'response_type': (TokenBaseResponse,),
                'auth': [
                    'basicAuth'
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'token_base_definition_update': 'body',
                },
                'collection_format_map': {
                }
            },
