...
class DashboardManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_dashboard(
            ...
            **kwargs
            ...
            >>> thread = api.create_dashboard(dashboard_request, async_req=True)
            >>> result = thread.get()

            Args:
                dashboard_request (DashboardRequest): Information to create the new dashboard.
        ...
        def __delete_dashboard(
            ...
            **kwargs
            ...
            Delete a dashboard by the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.delete_dashboard = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v2/dashboards/{id}',
        ...
        def __generate_dashboard_report(
            ...
            **kwargs
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['generate_report_request'] = \
                generate_report_request
            return self.call_with_http_info(**kwargs)

        self.generate_dashboard_report = _Endpoint(
            settings={
                'response_type': (BeginAsyncJobResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/dashboards/reportJobs',
                'operation_id': 'generate_dashboard_report',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__generate_dashboard_report
        )

        def __get_async_report_generation_result(
            self,
            job_id,
            **kwargs
        ):
            """Get report generation job result  # noqa: E501

            Get the result of an asynchronous report generation request for the given job identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_async_report_generation_result(job_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_async_report_generation_result = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/dashboards/reportJobs/{jobId}/result',
                'operation_id': 'get_async_report_generation_result',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_async_report_generation_result
        )

        def __get_async_report_generation_status(
            self,
            job_id,
            **kwargs
        ):
            """Get report generation job status  # noqa: E501

            Get the status of an asynchronous report generation request for the given job identifier. On success, use the [getReportGenerationResult](#operation/getAsyncReportGenerationResult) endpoint to get the result of the report generation job.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_async_report_generation_status(job_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_async_report_generation_status = _Endpoint(
            settings={
                'response_type': (AsyncJobStatus,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/dashboards/reportJobs/{jobId}/status',
                'operation_id': 'get_async_report_generation_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_async_report_generation_status
        )
        ...
        def __get_dashboard(
            ...
            **kwargs
            ...
            Get a dashboard by the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __update_dashboard(
            ...
            **kwargs
            ...
            Update a dashboard by the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_dashboard(id, dashboard_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the dashboard to update.
                dashboard_request (DashboardRequest): Information to update on the dashboard.
