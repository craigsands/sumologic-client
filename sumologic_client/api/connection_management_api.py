    ...
    def __init__(self, api_client=None):
        ...
        def __create_connection(
            ...
            **kwargs
            ...
            >>> thread = api.create_connection(connection_definition, async_req=True)
            >>> result = thread.get()

            Args:
                connection_definition (ConnectionDefinition): Information about the new connection.
        ...
        self.delete_connection = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/connections/{id}',
            ...
            root_map={
                'validations': {
                    ('type',): {
                        ...
                        'regex': {
                            'pattern': r'^(WebhookConnection|ServiceNowConnection)$',  # noqa: E501
                        },
                    },
                },
                'allowed_values': {
        ...
        def __get_connection(
            ...
            **kwargs
            ...
            >>> thread = api.get_connection(id, type="WebhookConnection", async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of connection to return.
                type (str): Type of connection to return. Valid values are `WebhookConnection`, `ServiceNowConnection`.. defaults to "WebhookConnection", must be one of ["WebhookConnection"]
        ...
        def __test_connection(
            ...
            **kwargs
            ...
            >>> thread = api.test_connection(connection_definition, async_req=True)
            >>> result = thread.get()
        ...
        self.test_connection = _Endpoint(
            settings={
                'response_type': (TestConnectionResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/connections/test',
        ...
        def __update_connection(
            ...
            **kwargs
            ...
            >>> thread = api.update_connection(id, connection_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the connection to update.
                connection_definition (ConnectionDefinition): Information to update about the connection.
