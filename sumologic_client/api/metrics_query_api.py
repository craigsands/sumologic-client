...
class MetricsQueryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __run_metrics_queries(
            self,
            metrics_query_request,
            **kwargs
        ):
            """Run metrics queries  # noqa: E501

            Execute up to six metrics queries. If you specify multiple queries, each is returned as a separate set of time series. For more information see [Metrics Queries](https://help.sumologic.com/?cid=10144).  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.run_metrics_queries(metrics_query_request, async_req=True)
            >>> result = thread.get()

            Args:
                metrics_query_request (MetricsQueryRequest): The parameters for the metrics query.
            ...
            kwargs['metrics_query_request'] = \
                metrics_query_request
            return self.call_with_http_info(**kwargs)

        self.run_metrics_queries = _Endpoint(
            settings={
                'response_type': (MetricsQueryResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/metricsQueries',
                'operation_id': 'run_metrics_queries',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__run_metrics_queries
        )
