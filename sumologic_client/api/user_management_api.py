    ...
    def __init__(self, api_client=None):
        ...
        def __create_user(
            ...
            **kwargs
            ...
            >>> thread = api.create_user(create_user_definition, async_req=True)
            >>> result = thread.get()

            Args:
                create_user_definition (CreateUserDefinition): Information about the new user.
        ...
        def __delete_user(
            ...
            **kwargs
            ...
            Delete a user with the given identifier from the organization and transfer their content to the user with the identifier specified in \"transferTo\".  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        def __disable_mfa(
            ...
            **kwargs
            ...
            Disable multi-factor authentication for given user.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.disable_mfa(id, disable_mfa_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the user to disable MFA for.
                disable_mfa_request (DisableMfaRequest): Email and Password of the user to disable MFA for.
            ...
            kwargs['id'] = \
                id
            kwargs['disable_mfa_request'] = \
                disable_mfa_request
            return self.call_with_http_info(**kwargs)

        self.disable_mfa = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/users/{id}/mfa/disable',
        ...
        self.list_users = _Endpoint(
            settings={
                'response_type': (ListUserModelsResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/users',
        ...
        def __request_change_email(
            ...
            **kwargs
            ...
            >>> thread = api.request_change_email(id, change_email_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the user to change email address.
                change_email_request (ChangeEmailRequest): New email address of the user.
            ...
            kwargs['id'] = \
                id
            kwargs['change_email_request'] = \
                change_email_request
            return self.call_with_http_info(**kwargs)

        self.request_change_email = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/users/{id}/email/requestChange',
                'operation_id': 'request_change_email',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__request_change_email
        )
        ...
        self.reset_password = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/users/{id}/password/reset',
        ...
        self.unlock_user = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/users/{id}/unlock',
        ...
        def __update_user(
            ...
            **kwargs
            ...
            >>> thread = api.update_user(id, update_user_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the user to update.
                update_user_definition (UpdateUserDefinition): Information to update about the user.
