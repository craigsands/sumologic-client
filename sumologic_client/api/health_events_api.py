...
class HealthEventsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __list_all_health_events(
            self,
            **kwargs
        ):
            """Get a list of health events.  # noqa: E501

            Get a list of all the unresolved health events in your account.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_all_health_events(async_req=True)
            >>> result = thread.get()
        ...
        self.list_all_health_events = _Endpoint(
            settings={
                'response_type': (ListHealthEventResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/healthEvents',
                'operation_id': 'list_all_health_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__list_all_health_events
        )

        def __list_all_health_events_for_resources(
            self,
            resource_identities,
            **kwargs
        ):
            """Health events for specific resources.  # noqa: E501

            Get a list of all the unresolved events in your account that belong to the supplied resource identifiers.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_all_health_events_for_resources(resource_identities, async_req=True)
            >>> result = thread.get()

            Args:
                resource_identities (ResourceIdentities): Resource identifiers to request health events from.
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['resource_identities'] = \
                resource_identities
            return self.call_with_http_info(**kwargs)

        self.list_all_health_events_for_resources = _Endpoint(
            settings={
                'response_type': (ListHealthEventResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/healthEvents/resources',
                'operation_id': 'list_all_health_events_for_resources',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_all_health_events_for_resources
        )
