...
class ContentPermissionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __add_content_permissions(
            self,
            id,
            content_permission_update_request,
            **kwargs
        ):
            ...
            >>> thread = api.add_content_permissions(id, content_permission_update_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): The identifier of the content item.
                content_permission_update_request (ContentPermissionUpdateRequest): New permissions to add to the content item with the given identifier.
            ...
            kwargs['id'] = \
                id
            kwargs['content_permission_update_request'] = \
                content_permission_update_request
            return self.call_with_http_info(**kwargs)

        self.add_content_permissions = _Endpoint(
            settings={
                'response_type': (ContentPermissionResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/content/{id}/permissions/add',
                'operation_id': 'add_content_permissions',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'content_permission_update_request': 'body',
            ...
            callable=__add_content_permissions
        )

        def __get_content_permissions(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_content_permissions = _Endpoint(
            settings={
                'response_type': (ContentPermissionResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/content/{id}/permissions',
                'operation_id': 'get_content_permissions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_content_permissions
        )

        def __remove_content_permissions(
            self,
            id,
            content_permission_update_request,
            **kwargs
            ...
            >>> thread = api.remove_content_permissions(id, content_permission_update_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): The identifier of the content item.
                content_permission_update_request (ContentPermissionUpdateRequest): Permissions to remove from a content item with the given identifier.
        ...
        self.remove_content_permissions = _Endpoint(
            settings={
                'response_type': (ContentPermissionResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/content/{id}/permissions/remove',
                'operation_id': 'remove_content_permissions',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__remove_content_permissions
        )
