...
class IngestBudgetManagementV1Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __assign_collector_to_budget(
            self,
            id,
            collector_id,
            **kwargs
        ...
        self.assign_collector_to_budget = _Endpoint(
            settings={
                'response_type': (IngestBudget,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets/{id}/collectors/{collectorId}',
                'operation_id': 'assign_collector_to_budget',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            callable=__assign_collector_to_budget
        )

        def __create_ingest_budget(
            self,
            ingest_budget_definition,
            **kwargs
        ):
            ...
            >>> thread = api.create_ingest_budget(ingest_budget_definition, async_req=True)
            >>> result = thread.get()

            Args:
                ingest_budget_definition (IngestBudgetDefinition): Information about the new ingest budget.
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['ingest_budget_definition'] = \
                ingest_budget_definition
            return self.call_with_http_info(**kwargs)

        self.create_ingest_budget = _Endpoint(
            settings={
                'response_type': (IngestBudget,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets',
                'operation_id': 'create_ingest_budget',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__create_ingest_budget
        )

        def __delete_ingest_budget(
            self,
            id,
            **kwargs
        ):
        ...
        self.delete_ingest_budget = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets/{id}',
                'operation_id': 'delete_ingest_budget',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_ingest_budget
        )

        def __get_assigned_collectors(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_assigned_collectors = _Endpoint(
            settings={
                'response_type': (ListCollectorIdentitiesResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets/{id}/collectors',
                'operation_id': 'get_assigned_collectors',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_assigned_collectors
        )

        def __get_ingest_budget(
            self,
            id,
            **kwargs
        ):
        ...
        self.get_ingest_budget = _Endpoint(
            settings={
                'response_type': (IngestBudget,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/ingestBudgets/{id}',
                'operation_id': 'get_ingest_budget',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ingest_budget
        )

        def __list_ingest_budgets(
            self,
            **kwargs
        ):
        ...
        self.list_ingest_budgets = _Endpoint(
            settings={
                'response_type': (ListIngestBudgetsResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets',
                'operation_id': 'list_ingest_budgets',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_ingest_budgets
        )

        def __remove_collector_from_budget(
            self,
            id,
            collector_id,
            **kwargs
        ...
        self.remove_collector_from_budget = _Endpoint(
            settings={
                'response_type': (IngestBudget,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/ingestBudgets/{id}/collectors/{collectorId}',
                'operation_id': 'remove_collector_from_budget',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__remove_collector_from_budget
        )
        ...
        self.reset_usage = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/ingestBudgets/{id}/usage/reset',
                'operation_id': 'reset_usage',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reset_usage
        )

        def __update_ingest_budget(
            self,
            id,
            ingest_budget_definition,
            **kwargs
            ...
            >>> thread = api.update_ingest_budget(id, ingest_budget_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the ingest budget to update.
                ingest_budget_definition (IngestBudgetDefinition): Information to update about the ingest budget.
        ...
        self.update_ingest_budget = _Endpoint(
            settings={
                'response_type': (IngestBudget,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/ingestBudgets/{id}',
                'operation_id': 'update_ingest_budget',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_ingest_budget
        )
