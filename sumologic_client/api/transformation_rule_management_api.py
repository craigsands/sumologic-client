...
class TransformationRuleManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_rule(
            self,
            transformation_rule_request,
            **kwargs
        ):
            """Create a new transformation rule.  # noqa: E501

            Create a new transformation rule.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_rule(transformation_rule_request, async_req=True)
            >>> result = thread.get()

            Args:
                transformation_rule_request (TransformationRuleRequest): The configuration of the transformation rule to create.
            ...
            kwargs['transformation_rule_request'] = \
                transformation_rule_request
            return self.call_with_http_info(**kwargs)

        self.create_rule = _Endpoint(
            settings={
                'response_type': (TransformationRuleResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/transformationRules',
            ...
            root_map={
                ...
                'location_map': {
                    'transformation_rule_request': 'body',
                },
        ...
        def __delete_rule(
            ...
            **kwargs
            ...
            """Delete a transformation rule.  # noqa: E501

            Delete a transformation rule with the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.delete_rule = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/transformationRules/{id}',
        ...
        def __get_transformation_rule(
            self,
            id,
            **kwargs
        ):
            """Get a transformation rule.  # noqa: E501

            Get a transformation rule with the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_transformation_rule(id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_transformation_rule = _Endpoint(
            settings={
                'response_type': (TransformationRuleResponse,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/transformationRules/{id}',
                'operation_id': 'get_transformation_rule',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_transformation_rule
        )

        def __get_transformation_rules(
            self,
            **kwargs
        ):
            """Get a list of transformation rules.  # noqa: E501

            Get a list of transformation rules in the organization. The response is paginated with a default limit of 100 rules per page.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_transformation_rules(async_req=True)
            >>> result = thread.get()
        ...
        self.get_transformation_rules = _Endpoint(
            settings={
                'response_type': (TransformationRulesResponse,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/transformationRules',
                'operation_id': 'get_transformation_rules',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_transformation_rules
        )

        def __update_transformation_rule(
            self,
            id,
            transformation_rule_request,
            **kwargs
        ):
            """Update a transformation rule.  # noqa: E501

            Update an existing transformation rule. All properties specified in the request are replaced. Missing properties will remain the same.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_transformation_rule(id, transformation_rule_request, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the transformation rule to update.
                transformation_rule_request (TransformationRuleRequest): Information to update about the transformation rule.
        ...
        self.update_transformation_rule = _Endpoint(
            settings={
                'response_type': (TransformationRuleResponse,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/transformationRules/{id}',
                'operation_id': 'update_transformation_rule',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_transformation_rule
        )
