...
class IngestBudgetManagementV2Api(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_ingest_budget_v2(
            self,
            ingest_budget_definition_v2,
            **kwargs
        ):
            ...
            >>> thread = api.create_ingest_budget_v2(ingest_budget_definition_v2, async_req=True)
            >>> result = thread.get()

            Args:
                ingest_budget_definition_v2 (IngestBudgetDefinitionV2): Information about the new ingest budget.
            ...
            kwargs['ingest_budget_definition_v2'] = \
                ingest_budget_definition_v2
            return self.call_with_http_info(**kwargs)

        self.create_ingest_budget_v2 = _Endpoint(
            settings={
                'response_type': (IngestBudgetV2,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/ingestBudgets',
                'operation_id': 'create_ingest_budget_v2',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'ingest_budget_definition_v2': 'body',
                },
            ...
            callable=__create_ingest_budget_v2
        )

        def __delete_ingest_budget_v2(
            self,
            id,
            **kwargs
        ):
            ...
            >>> thread = api.delete_ingest_budget_v2(id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_ingest_budget_v2 = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/ingestBudgets/{id}',
                'operation_id': 'delete_ingest_budget_v2',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_ingest_budget_v2
        )

        def __get_ingest_budget_v2(
            self,
            id,
            **kwargs
        ):
            ...
            >>> thread = api.get_ingest_budget_v2(id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_ingest_budget_v2 = _Endpoint(
            settings={
                'response_type': (IngestBudgetV2,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v2/ingestBudgets/{id}',
                'operation_id': 'get_ingest_budget_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ingest_budget_v2
        )

        def __list_ingest_budgets_v2(
            self,
            **kwargs
        ):
            ...
            >>> thread = api.list_ingest_budgets_v2(async_req=True)
            >>> result = thread.get()
        ...
        self.list_ingest_budgets_v2 = _Endpoint(
            settings={
                'response_type': (ListIngestBudgetsResponseV2,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/ingestBudgets',
                'operation_id': 'list_ingest_budgets_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_ingest_budgets_v2
        )

        def __reset_usage_v2(
            self,
            id,
            **kwargs
        ):
            ...
            >>> thread = api.reset_usage_v2(id, async_req=True)
            >>> result = thread.get()
        ...
        self.reset_usage_v2 = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v2/ingestBudgets/{id}/usage/reset',
                'operation_id': 'reset_usage_v2',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__reset_usage_v2
        )

        def __update_ingest_budget_v2(
            self,
            id,
            ingest_budget_definition_v2,
            **kwargs
            ...
            >>> thread = api.update_ingest_budget_v2(id, ingest_budget_definition_v2, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the ingest budget to update.
                ingest_budget_definition_v2 (IngestBudgetDefinitionV2): Information to update about the ingest budget.
        ...
        self.update_ingest_budget_v2 = _Endpoint(
            settings={
                'response_type': (IngestBudgetV2,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v2/ingestBudgets/{id}',
                'operation_id': 'update_ingest_budget_v2',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_ingest_budget_v2
        )
