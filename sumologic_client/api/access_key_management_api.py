...
class AccessKeyManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_access_key(
            ...
            **kwargs
            ...
            kwargs['access_key_create_request'] = \
                access_key_create_request
            return self.call_with_http_info(**kwargs)

        self.create_access_key = _Endpoint(
            settings={
                'response_type': (AccessKey,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/accessKeys',
            ...
            root_map={
                ...
                'location_map': {
                    'access_key_create_request': 'body',
                },
            ...
            callable=__create_access_key
        )

        def __delete_access_key(
            self,
            id,
            **kwargs
        ):
            ...
            Deletes the access key with the given accessId.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_access_key(id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_access_key = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/accessKeys/{id}',
            ...
            api_client=api_client,
            callable=__delete_access_key
        )

        def __list_access_keys(
            self,
            **kwargs
        ):
            """List all access keys.  # noqa: E501

            List all access keys in your account.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.list_access_keys = _Endpoint(
            settings={
                'response_type': (PaginatedListAccessKeysResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/accessKeys',
            ...
            api_client=api_client,
            callable=__list_access_keys
        )

        def __list_personal_access_keys(
            self,
            **kwargs
        ):
            """List personal keys.  # noqa: E501

            List all access keys that belong to your user.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_personal_access_keys(async_req=True)
            >>> result = thread.get()
        ...
        self.list_personal_access_keys = _Endpoint(
            settings={
                'response_type': (ListAccessKeysResult,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/accessKeys/personal',
                'operation_id': 'list_personal_access_keys',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__list_personal_access_keys
        )

        def __update_access_key(
            self,
            id,
            ...
            **kwargs
            ...
            Updates the properties of existing accessKey by accessId. It can be used to enable or disable the access key and to update the corsHeaders list.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_access_key(id, access_key_update_request, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['id'] = \
                id
            kwargs['access_key_update_request'] = \
                access_key_update_request
            return self.call_with_http_info(**kwargs)

        self.update_access_key = _Endpoint(
            settings={
                'response_type': (AccessKeyPublic,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/accessKeys/{id}',
                'operation_id': 'update_access_key',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'access_key_update_request': 'body',
                },
                'collection_format_map': {
                }
            },
