    ...
    def __init__(self, api_client=None):
        ...
        def __get_password_policy(
            ...
            **kwargs
            ...
            """Get the current password policy.  # noqa: E501
        ...
        self.get_password_policy = _Endpoint(
            settings={
                'response_type': (PasswordPolicy,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/passwordPolicy',
            ...
            callable=__get_password_policy
        )

        def __set_password_policy(
            self,
            password_policy,
            **kwargs
        ):
            """Update password policy.  # noqa: E501

            Update the current password policy.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.set_password_policy(password_policy, async_req=True)
            >>> result = thread.get()
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['password_policy'] = \
                password_policy
            return self.call_with_http_info(**kwargs)

        self.set_password_policy = _Endpoint(
            settings={
                'response_type': (PasswordPolicy,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/passwordPolicy',
                'operation_id': 'set_password_policy',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__set_password_policy
        )
