...
class LookupManagementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_table(
            ...
            **kwargs
            ...
            kwargs['lookup_table_definition'] = \
                lookup_table_definition
            return self.call_with_http_info(**kwargs)

        self.create_table = _Endpoint(
            settings={
                'response_type': (LookupTable,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables',
        ...
        def __delete_table(
            ...
            **kwargs
            ...
            """Delete a lookup table.  # noqa: E501

            Delete a lookup table completely.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_table(id, async_req=True)
            >>> result = thread.get()
        ...
        self.delete_table = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables/{id}',
            ...
            api_client=api_client,
            callable=__delete_table
        )

        def __delete_table_row(
            self,
            id,
            row_delete_definition,
            **kwargs
        ):
            """Delete a lookup table row.  # noqa: E501

            Delete a row from lookup table by giving primary key. The complete set of primary key fields of the lookup table should be provided.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.delete_table_row(id, row_delete_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the lookup table.
                row_delete_definition (RowDeleteDefinition): Lookup table row delete definition.
            ...
            kwargs['id'] = \
                id
            kwargs['row_delete_definition'] = \
                row_delete_definition
            return self.call_with_http_info(**kwargs)

        self.delete_table_row = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables/{id}/deleteTableRow',
                'operation_id': 'delete_table_row',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__delete_table_row
        )

        def __lookup_table_by_id(
            self,
            id,
            **kwargs
        ):
            """Get a lookup table.  # noqa: E501

            Get a lookup table for the given identifier.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.lookup_table_by_id(id, async_req=True)
            >>> result = thread.get()
        ...
        self.lookup_table_by_id = _Endpoint(
            settings={
                'response_type': (LookupTable,),
                'auth': [
                    'basicAuth'
                ...
                'endpoint_path': '/v1/lookupTables/{id}',
                'operation_id': 'lookup_table_by_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__lookup_table_by_id
        )

        def __request_job_status(
            self,
            job_id,
            **kwargs
        ):
            """Get the status of an async job.  # noqa: E501

            Retrieve the status of a previously made request. If the request was successful, the status of the response object will be `Success`.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.request_job_status(job_id, async_req=True)
            >>> result = thread.get()
        ...
        self.request_job_status = _Endpoint(
            settings={
                'response_type': (LookupAsyncJobStatus,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables/jobs/{jobId}/status',
                'operation_id': 'request_job_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__request_job_status
        )

        def __truncate_table(
            self,
            id,
            **kwargs
        ):
            """Empty a lookup table.  # noqa: E501

            Delete all data from a lookup table.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.truncate_table(id, async_req=True)
            >>> result = thread.get()
        ...
        self.truncate_table = _Endpoint(
            settings={
                'response_type': (LookupRequestToken,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables/{id}/truncate',
                'operation_id': 'truncate_table',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__truncate_table
        )

        def __update_table(
            self,
            id,
            lookup_update_definition,
            **kwargs
        ):
            """Edit a lookup table.  # noqa: E501

            Edit the lookup table data. All the fields are mandatory in the request.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_table(id, lookup_update_definition, async_req=True)
            >>> result = thread.get()

            Args:
                id (str): Identifier of the lookup table.
                lookup_update_definition (LookupUpdateDefinition): The configuration changes for the lookup table.
            ...
            kwargs['id'] = \
                id
            kwargs['lookup_update_definition'] = \
                lookup_update_definition
            return self.call_with_http_info(**kwargs)

        self.update_table = _Endpoint(
            settings={
                'response_type': (LookupTable,),
                'auth': [
                    'basicAuth'
        ...
        def __update_table_row(
            ...
            **kwargs
            ...
            kwargs['id'] = \
                id
            kwargs['row_update_definition'] = \
                row_update_definition
            return self.call_with_http_info(**kwargs)

        self.update_table_row = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/v1/lookupTables/{id}/row',
                'operation_id': 'update_table_row',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        def __upload_file(
            ...
            **kwargs
            ...
            """Upload a CSV file.  # noqa: E501

            Create a request to populate a lookup table with a CSV file.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.upload_file(id, file, async_req=True)
            >>> result = thread.get()
        ...
        self.upload_file = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v1/lookupTables/{id}/upload',
