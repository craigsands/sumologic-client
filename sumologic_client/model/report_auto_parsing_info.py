...
class ReportAutoParsingInfo(ModelNormal):
    ...
    validations = {
        ('mode',): {
            'regex': {
                'pattern': r'^(intelligent|performance)$|^$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ReportAutoParsingInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            mode (str): Can be `intelligent` or `performance`. [optional] if omitted the server will use the default value of "performance"  # noqa: E501
        """
