...
def lazy_import():
    ...
    globals()['SignalsResponse'] = SignalsResponse
    globals()['WarningDetails'] = WarningDetails


class SignalsJobResult(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'signals': ([SignalsResponse],),  # noqa: E501
            'warnings': ([WarningDetails],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_complete, signals, warnings, *args, **kwargs):  # noqa: E501
        """SignalsJobResult - a model defined in OpenAPI

        Args:
            is_complete (bool): Whether the signal computing job finished.
            signals ([SignalsResponse]): Sequence of computed signals.
            warnings ([WarningDetails]): List of warnings while computing signals.
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_complete, signals, warnings, *args, **kwargs):  # noqa: E501
        """SignalsJobResult - a model defined in OpenAPI
