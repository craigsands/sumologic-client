...
class ConfigureSubdomainRequest(ModelNormal):
    ...
    validations = {
        ('subdomain',): {
            ...
            'min_length': 4,
            'regex': {
                'pattern': r'^(?!xn--)[a-z]([a-z0-9-]*[a-z0-9])?$',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subdomain, *args, **kwargs):  # noqa: E501
        """ConfigureSubdomainRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, subdomain, *args, **kwargs):  # noqa: E501
        """ConfigureSubdomainRequest - a model defined in OpenAPI
