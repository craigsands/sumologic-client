...
class ConnectionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of webhook connection. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `NewRelic`, `Opsgenie`, `PagerDuty`, `Slack`, `MicrosoftTeams`, `ServiceNow`, `SumoCloudSOAR` and `Webhook`..  # noqa: E501

        Keyword Args:
            value (str): Type of webhook connection. Valid values are `AWSLambda`, `Azure`, `Datadog`, `HipChat`, `NewRelic`, `Opsgenie`, `PagerDuty`, `Slack`, `MicrosoftTeams`, `ServiceNow`, `SumoCloudSOAR` and `Webhook`..  # noqa: E501
