...
def lazy_import():
    ...
    globals()['UnvalidatedMonitorQuery'] = UnvalidatedMonitorQuery


class MonitorQueries(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'queries': ([UnvalidatedMonitorQuery],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, monitor_type, time_range, queries, *args, **kwargs):  # noqa: E501
        """MonitorQueries - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, monitor_type, time_range, queries, *args, **kwargs):  # noqa: E501
        """MonitorQueries - a model defined in OpenAPI
