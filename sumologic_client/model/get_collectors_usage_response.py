...
class GetCollectorsUsageResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """GetCollectorsUsageResponse - a model defined in OpenAPI

        Args:
            data ([Collector]): List of collectors.
