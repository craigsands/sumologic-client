...
class AsyncJobStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'error': (ErrorDescription,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status_message (str): Additional status message generated if the status is not `Failed`.. [optional]  # noqa: E501
            error (ErrorDescription): [optional]  # noqa: E501
        """
