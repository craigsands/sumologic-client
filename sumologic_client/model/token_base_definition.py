...
class TokenBaseDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, status, type, *args, **kwargs):  # noqa: E501
        """TokenBaseDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, status, type, *args, **kwargs):  # noqa: E501
        """TokenBaseDefinition - a model defined in OpenAPI
