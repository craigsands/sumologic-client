...
def lazy_import():
    ...
    globals()['HealthEvent'] = HealthEvent


class ListHealthEventResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListHealthEventResponse - a model defined in OpenAPI

        Args:
            data ([HealthEvent]): List of health events.
