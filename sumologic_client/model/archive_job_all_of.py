...
class ArchiveJobAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'total_objects_scanned': (int,),  # noqa: E501
            'total_objects_ingested': (int,),  # noqa: E501
            'total_bytes_ingested': (int,),  # noqa: E501
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'total_objects_scanned': 'totalObjectsScanned',  # noqa: E501
        'total_objects_ingested': 'totalObjectsIngested',  # noqa: E501
        'total_bytes_ingested': 'totalBytesIngested',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, total_objects_scanned, total_objects_ingested, total_bytes_ingested, status, created_at, created_by, *args, **kwargs):  # noqa: E501
        """ArchiveJobAllOf - a model defined in OpenAPI
        ...
        self.id = id
        self.total_objects_scanned = total_objects_scanned
        self.total_objects_ingested = total_objects_ingested
        self.total_bytes_ingested = total_bytes_ingested
        self.status = status
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, total_objects_scanned, total_objects_ingested, total_bytes_ingested, status, created_at, created_by, *args, **kwargs):  # noqa: E501
        """ArchiveJobAllOf - a model defined in OpenAPI
