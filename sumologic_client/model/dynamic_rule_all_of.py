...
class DynamicRuleAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_system_rule, *args, **kwargs):  # noqa: E501
        """DynamicRuleAllOf - a model defined in OpenAPI
        ...
        self.id = id
        self.is_system_rule = is_system_rule
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_system_rule, *args, **kwargs):  # noqa: E501
        """DynamicRuleAllOf - a model defined in OpenAPI
