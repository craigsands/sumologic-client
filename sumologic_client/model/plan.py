...
class Plan(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_id, product_name, product_groups, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_id, product_name, product_groups, *args, **kwargs):  # noqa: E501
        """Plan - a model defined in OpenAPI
