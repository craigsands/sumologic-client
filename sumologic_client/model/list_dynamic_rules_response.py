...
def lazy_import():
    ...
    globals()['DynamicRule'] = DynamicRule


class ListDynamicRulesResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListDynamicRulesResponse - a model defined in OpenAPI
