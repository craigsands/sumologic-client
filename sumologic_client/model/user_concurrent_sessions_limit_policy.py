...
class UserConcurrentSessionsLimitPolicy(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'max_concurrent_sessions': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'max_concurrent_sessions': 'maxConcurrentSessions',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, enabled, *args, **kwargs):  # noqa: E501
        """UserConcurrentSessionsLimitPolicy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            max_concurrent_sessions (int): Maximum number of concurrent sessions a user may have.. [optional] if omitted the server will use the default value of 100  # noqa: E501
        """
