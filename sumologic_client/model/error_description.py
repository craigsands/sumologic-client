...
class ErrorDescription(ModelNormal):
    ...
    def _from_openapi_data(cls, code, message, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            detail (str): An optional fuller English-language description of the error.. [optional]  # noqa: E501
            meta ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): An optional list of metadata about the error.. [optional]  # noqa: E501
        """
