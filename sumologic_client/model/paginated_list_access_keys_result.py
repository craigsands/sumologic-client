...
class PaginatedListAccessKeysResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([AccessKeyPublic],),  # noqa: E501
            'next': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """PaginatedListAccessKeysResult - a model defined in OpenAPI

        Args:
            data ([AccessKeyPublic]): An array of access keys.
