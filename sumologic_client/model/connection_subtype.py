...
class ConnectionSubtype(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ConnectionSubtype - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The subtype of the connection. Valid values are `Event` or `Incident`..  # noqa: E501

        Keyword Args:
            value (str): The subtype of the connection. Valid values are `Event` or `Incident`..  # noqa: E501
