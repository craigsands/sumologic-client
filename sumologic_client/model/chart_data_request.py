...
class ChartDataRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, monitor_type, queries, *args, **kwargs):  # noqa: E501
        """ChartDataRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            triggers ([TriggerCondition]): Defines the conditions of when to send notifications.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, monitor_type, queries, *args, **kwargs):  # noqa: E501
        """ChartDataRequest - a model defined in OpenAPI
