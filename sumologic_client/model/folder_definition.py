...
class FolderDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, parent_id, *args, **kwargs):  # noqa: E501
        """FolderDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, parent_id, *args, **kwargs):  # noqa: E501
        """FolderDefinition - a model defined in OpenAPI
