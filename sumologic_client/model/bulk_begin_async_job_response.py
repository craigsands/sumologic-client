...
class BulkBeginAsyncJobResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job_ids, errors, *args, **kwargs):  # noqa: E501
        """BulkBeginAsyncJobResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, job_ids, errors, *args, **kwargs):  # noqa: E501
        """BulkBeginAsyncJobResponse - a model defined in OpenAPI
