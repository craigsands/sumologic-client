...
class OutlierDirection2(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OutlierDirection2 - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Specifies which direction should trigger violations.. if omitted defaults to "Both"  # noqa: E501

        Keyword Args:
            value (str): Specifies which direction should trigger violations.. if omitted defaults to "Both"  # noqa: E501
