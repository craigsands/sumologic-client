...
class DashboardSyncDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, detail_level, properties, panels, filters, *args, **kwargs):  # noqa: E501
        """DashboardSyncDefinitionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, detail_level, properties, panels, filters, *args, **kwargs):  # noqa: E501
        """DashboardSyncDefinitionAllOf - a model defined in OpenAPI
