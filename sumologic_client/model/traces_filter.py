...
class TracesFilter(ModelNormal):
    ...
    validations = {
        ('type',): {
            'regex': {
                'pattern': r'^(FieldDescriptor|DurationMetricDescriptor|NumericMetricDescriptor|CPCOfFilterDescriptor|MaxCPCOfFilterDescriptor|MaxCPCFilterDescriptor)$|^$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """TracesFilter - a model defined in OpenAPI
