...
class ServiceNowConnectionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, username, *args, **kwargs):  # noqa: E501
        """ServiceNowConnectionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, username, *args, **kwargs):  # noqa: E501
        """ServiceNowConnectionAllOf - a model defined in OpenAPI
