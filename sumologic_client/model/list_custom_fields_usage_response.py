...
def lazy_import():
    ...
    globals()['CustomFieldUsage'] = CustomFieldUsage


class ListCustomFieldsUsageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CustomFieldUsage],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListCustomFieldsUsageResponse - a model defined in OpenAPI

        Args:
            data ([CustomFieldUsage]): List of fields with their usages.
