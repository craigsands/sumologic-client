...
class ListFieldNamesResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListFieldNamesResponse - a model defined in OpenAPI

        Args:
            data ([FieldName]): List of all built-in and custom field names.
