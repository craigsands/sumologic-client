...
def lazy_import():
    ...
    globals()['SearchQueryFieldAndType'] = SearchQueryFieldAndType


class SearchQueryFieldsAndTypes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SearchQueryFieldsAndTypes - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([SearchQueryFieldAndType]):  # noqa: E501

        Keyword Args:
            value ([SearchQueryFieldAndType]):  # noqa: E501
