...
class Collector(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, collector_id, collector_name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, collector_id, collector_name, *args, **kwargs):  # noqa: E501
        """Collector - a model defined in OpenAPI
