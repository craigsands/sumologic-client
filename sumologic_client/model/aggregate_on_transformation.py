...
def lazy_import():
    ...
    globals()['AggregateOnTransformationAllOf'] = AggregateOnTransformationAllOf
    globals()['DimensionTransformation'] = DimensionTransformation


class AggregateOnTransformation(ModelComposed):
    ...
    attribute_map = {
        'aggregate_on': 'aggregateOn',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AggregateOnTransformation - a model defined in OpenAPI

        Keyword Args:
            aggregate_on ([str]): A list of dimensions that should be aggregated on.. defaults to []  # noqa: E501
        ...
        aggregate_on = kwargs.get('aggregate_on', [])
