...
def lazy_import():
    ...
    globals()['BillingFrequency'] = BillingFrequency
...
class UpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_id, billing_frequency, baselines, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_id, billing_frequency, baselines, *args, **kwargs):  # noqa: E501
        """UpdateRequest - a model defined in OpenAPI
