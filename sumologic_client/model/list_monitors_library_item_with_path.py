...
def lazy_import():
    ...
    globals()['MonitorsLibraryItemWithPath'] = MonitorsLibraryItemWithPath


class ListMonitorsLibraryItemWithPath(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListMonitorsLibraryItemWithPath - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MonitorsLibraryItemWithPath]): Multi-type list of types monitor or folder..  # noqa: E501

        Keyword Args:
            value ([MonitorsLibraryItemWithPath]): Multi-type list of types monitor or folder..  # noqa: E501
