...
class ListTokensBaseResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([TokenBaseResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListTokensBaseResponse - a model defined in OpenAPI

        Args:
            data ([TokenBaseResponse]): List of tokens.
