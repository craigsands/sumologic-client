...
def lazy_import():
    ...
    globals()['EntitlementConsumption'] = EntitlementConsumption


class ConsumptionDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'entitlement_consumptions': ([EntitlementConsumption],),  # noqa: E501
    ...
    attribute_map = {
        'entitlement_consumptions': 'entitlementConsumptions',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, entitlement_consumptions, start_date, end_date, *args, **kwargs):  # noqa: E501
        """ConsumptionDetails - a model defined in OpenAPI

        Args:
            entitlement_consumptions ([EntitlementConsumption]): An array of entitlements.
        ...
        self.entitlement_consumptions = entitlement_consumptions
    ...
    @convert_js_args_to_python_args
    def __init__(self, entitlement_consumptions, start_date, end_date, *args, **kwargs):  # noqa: E501
        """ConsumptionDetails - a model defined in OpenAPI
