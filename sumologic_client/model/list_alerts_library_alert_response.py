...
class ListAlertsLibraryAlertResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListAlertsLibraryAlertResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AlertsLibraryAlertResponse]): List of Alerts..  # noqa: E501

        Keyword Args:
            value ([AlertsLibraryAlertResponse]): List of Alerts..  # noqa: E501
