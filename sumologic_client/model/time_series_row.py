...
def lazy_import():
    ...
    globals()['TimeSeriesList'] = TimeSeriesList


class TimeSeriesRow(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'time_series_list': (TimeSeriesList,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, row_id, time_series_list, *args, **kwargs):  # noqa: E501
        """TimeSeriesRow - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, row_id, time_series_list, *args, **kwargs):  # noqa: E501
        """TimeSeriesRow - a model defined in OpenAPI
