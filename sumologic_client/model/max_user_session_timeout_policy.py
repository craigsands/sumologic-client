...
class MaxUserSessionTimeoutPolicy(ModelNormal):
    ...
    validations = {
        ('max_user_session_timeout',): {
            'regex': {
                'pattern': r'^(5m|15m|30m|1h|2h|6h|12h|1d|2d|3d|5d|7d)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        """
        return {
            'max_user_session_timeout': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'max_user_session_timeout': 'maxUserSessionTimeout',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, max_user_session_timeout, *args, **kwargs):  # noqa: E501
        """MaxUserSessionTimeoutPolicy - a model defined in OpenAPI
        ...
        self.max_user_session_timeout = max_user_session_timeout
    ...
    @convert_js_args_to_python_args
    def __init__(self, max_user_session_timeout, *args, **kwargs):  # noqa: E501
        """MaxUserSessionTimeoutPolicy - a model defined in OpenAPI
