...
def lazy_import():
    ...
    globals()['ParameterAutoCompleteSyncDefinition'] = ParameterAutoCompleteSyncDefinition


class QueryParameterSyncDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'value': (str,),  # noqa: E501
            'auto_complete': (ParameterAutoCompleteSyncDefinition,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, label, description, data_type, value, auto_complete, *args, **kwargs):  # noqa: E501
        """QueryParameterSyncDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, description, data_type, value, auto_complete, *args, **kwargs):  # noqa: E501
        """QueryParameterSyncDefinition - a model defined in OpenAPI
