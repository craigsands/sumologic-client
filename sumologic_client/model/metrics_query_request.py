...
def lazy_import():
    ...
    globals()['MetricsQueryRow'] = MetricsQueryRow
    globals()['ResolvableTimeRange'] = ResolvableTimeRange


class MetricsQueryRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'queries': ([MetricsQueryRow],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, queries, time_range, *args, **kwargs):  # noqa: E501
        """MetricsQueryRequest - a model defined in OpenAPI

        Args:
            queries ([MetricsQueryRow]): A list of metrics queries.
    ...
    @convert_js_args_to_python_args
    def __init__(self, queries, time_range, *args, **kwargs):  # noqa: E501
        """MetricsQueryRequest - a model defined in OpenAPI
