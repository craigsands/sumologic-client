...
class UpdateRoleDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, description, filter_predicate, users, capabilities, *args, **kwargs):  # noqa: E501
        """UpdateRoleDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, filter_predicate, users, capabilities, *args, **kwargs):  # noqa: E501
        """UpdateRoleDefinition - a model defined in OpenAPI
