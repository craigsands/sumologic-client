...
def lazy_import():
    ...
    globals()['OutlierDataValue'] = OutlierDataValue
    globals()['OutlierSeriesDataPointAllOf'] = OutlierSeriesDataPointAllOf


class OutlierSeriesDataPoint(ModelComposed):
    ...
    validations = {
        ('data_point_type',): {
            'regex': {
                'pattern': r'^(OutlierSeriesData|StaticSeriesData)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            'x': (int,),  # noqa: E501
            'y': (OutlierDataValue,),  # noqa: E501
            'data_point_type': (str,),  # noqa: E501
        }
    ...
    def discriminator():
        ...
        if not val:
            return None
        return {'data_point_type': val}

    attribute_map = {
        'x': 'x',  # noqa: E501
        'y': 'y',  # noqa: E501
        'data_point_type': 'dataPointType',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OutlierSeriesDataPoint - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_point_type (str): Type of the data point.. [optional]  # noqa: E501
        """
