...
class AlertsLibraryItemWithPath(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'item': (AlertsLibraryBaseResponse,),  # noqa: E501
            'path': (str,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item, path, *args, **kwargs):  # noqa: E501
        """AlertsLibraryItemWithPath - a model defined in OpenAPI

        Args:
            item (AlertsLibraryBaseResponse):
    ...
    @convert_js_args_to_python_args
    def __init__(self, item, path, *args, **kwargs):  # noqa: E501
        """AlertsLibraryItemWithPath - a model defined in OpenAPI
