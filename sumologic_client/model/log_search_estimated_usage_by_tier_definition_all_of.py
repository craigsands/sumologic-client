...
class LogSearchEstimatedUsageByTierDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, estimated_usage_details, *args, **kwargs):  # noqa: E501
        """LogSearchEstimatedUsageByTierDefinitionAllOf - a model defined in OpenAPI
        ...
        self.estimated_usage_details = estimated_usage_details
    ...
    @convert_js_args_to_python_args
    def __init__(self, estimated_usage_details, *args, **kwargs):  # noqa: E501
        """LogSearchEstimatedUsageByTierDefinitionAllOf - a model defined in OpenAPI
