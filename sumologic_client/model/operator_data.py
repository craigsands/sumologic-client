...
def lazy_import():
    ...
    globals()['OperatorParameter'] = OperatorParameter


class OperatorData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'parameters': ([OperatorParameter],),  # noqa: E501
        }
    ...
    attribute_map = {
        'operator_name': 'operatorName',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, operator_name, parameters, *args, **kwargs):  # noqa: E501
        """OperatorData - a model defined in OpenAPI

        Args:
            operator_name (str): The name of the metrics operator.
            parameters ([OperatorParameter]): A list of operator parameters for the operator data.
    ...
    @convert_js_args_to_python_args
    def __init__(self, operator_name, parameters, *args, **kwargs):  # noqa: E501
        """OperatorData - a model defined in OpenAPI
