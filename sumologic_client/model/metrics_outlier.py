...
class MetricsOutlier(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'trimmed_query': (str,),  # noqa: E501
            'baseline_window': (str,),  # noqa: E501
            'baseline_time_range_window': (ResolvableTimeRange,),  # noqa: E501
    ...
    attribute_map = {
        'trimmed_query': 'trimmedQuery',  # noqa: E501
        'baseline_window': 'baselineWindow',  # noqa: E501
        'baseline_time_range_window': 'baselineTimeRangeWindow',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MetricsOutlier - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            trimmed_query (str): The query string after trimming out the outlier clause.. [optional]  # noqa: E501
            baseline_window (str): The time range used to compute the baseline.. [optional] if omitted the server will use the default value of "5m"  # noqa: E501
            baseline_time_range_window (ResolvableTimeRange): [optional]  # noqa: E501
            direction (str): Specifies which direction should trigger violations. Valid values:   1. `Both`: Both positive and negative deviations   2. `Up`: Positive deviations only   3. `Down`: Negative deviations only example: \"Up\" pattern: \"^(Both|Up|Down)$\" default: \"Both\" x-pattern-message: \"should be one of the following: 'Both', 'Up', 'Down'\". [optional]  # noqa: E501
