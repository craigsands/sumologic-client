...
def lazy_import():
    ...
    globals()['MetricsQueryData'] = MetricsQueryData
    globals()['TracesQueryData'] = TracesQueryData
...
class Query(ModelNormal):
    ...
    validations = {
        ('query_type',): {
            'regex': {
                'pattern': r'^(Logs|Metrics|Traces)$',  # noqa: E501
            },
        },
        ('metrics_query_mode',): {
            'regex': {
                'pattern': r'^(Basic|Advanced|basic|advanced)$',  # noqa: E501
            },
        },
        ('parse_mode',): {
            'regex': {
                'pattern': r'^(Auto|Manual)$',  # noqa: E501
            },
        },
        ('time_source',): {
            'regex': {
                'pattern': r'^(Message|Receipt)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'query_key': (str,),  # noqa: E501
            'metrics_query_mode': (str,),  # noqa: E501
            'metrics_query_data': (MetricsQueryData,),  # noqa: E501
            'traces_query_data': (TracesQueryData,),  # noqa: E501
            'parse_mode': (str,),  # noqa: E501
            'time_source': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'query_key': 'queryKey',  # noqa: E501
        'metrics_query_mode': 'metricsQueryMode',  # noqa: E501
        'metrics_query_data': 'metricsQueryData',  # noqa: E501
        'traces_query_data': 'tracesQueryData',  # noqa: E501
        'parse_mode': 'parseMode',  # noqa: E501
        'time_source': 'timeSource',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query_string, query_type, query_key, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            metrics_query_mode (str): The mode of the metrics query that the user was editing. Can be `Basic` or `Advanced`. Will ONLY be specified for metrics queries. . [optional]  # noqa: E501
            metrics_query_data (MetricsQueryData): [optional]  # noqa: E501
            traces_query_data (TracesQueryData): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_string, query_type, query_key, *args, **kwargs):  # noqa: E501
        """Query - a model defined in OpenAPI
