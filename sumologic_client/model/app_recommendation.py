...
class AppRecommendation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, name, description, icon_url, confidence, *args, **kwargs):  # noqa: E501
        """AppRecommendation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, name, description, icon_url, confidence, *args, **kwargs):  # noqa: E501
        """AppRecommendation - a model defined in OpenAPI
