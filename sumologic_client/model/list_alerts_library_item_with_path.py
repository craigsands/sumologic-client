...
def lazy_import():
    ...
    globals()['AlertsLibraryItemWithPath'] = AlertsLibraryItemWithPath


class ListAlertsLibraryItemWithPath(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListAlertsLibraryItemWithPath - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AlertsLibraryItemWithPath]): Multi-type list of types alert or folder..  # noqa: E501

        Keyword Args:
            value ([AlertsLibraryItemWithPath]): Multi-type list of types alert or folder..  # noqa: E501
