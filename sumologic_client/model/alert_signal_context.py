...
def lazy_import():
    ...
    globals()['AlertSignalContext'] = AlertSignalContext
    globals()['AlertSignalContextAllOf'] = AlertSignalContextAllOf
    globals()['SignalContext'] = SignalContext


class AlertSignalContext(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'Alert': AlertSignalContext,
        }
        if not val:
            return None
        return {'context_type': val}
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AlertSignalContext - a model defined in OpenAPI
