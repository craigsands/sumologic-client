...
class Template(ModelNormal):
    ...
    validations = {
        ('template_type',): {
            'regex': {
                'pattern': r'^(DashboardTemplate|DashboardReportModeTemplate)$',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, template_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, template_type, *args, **kwargs):  # noqa: E501
        """Template - a model defined in OpenAPI
