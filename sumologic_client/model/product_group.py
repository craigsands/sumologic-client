...
def lazy_import():
    ...
    globals()['ProductVariable'] = ProductVariable


class ProductGroup(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'product_group_name': (str,),  # noqa: E501
            'product_variables': ([ProductVariable],),  # noqa: E501
        }
    ...
    attribute_map = {
        'product_group_name': 'productGroupName',  # noqa: E501
        'product_variables': 'productVariables',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_group_name, product_variables, *args, **kwargs):  # noqa: E501
        """ProductGroup - a model defined in OpenAPI

        Args:
            product_group_name (str): Name of the Product group: 
            product_variables ([ProductVariable]): Different product variables of the product group
        ...
        self.product_variables = product_variables
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_group_name, product_variables, *args, **kwargs):  # noqa: E501
        """ProductGroup - a model defined in OpenAPI
