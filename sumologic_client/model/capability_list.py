...
class CapabilityList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CapabilityDefinition],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """CapabilityList - a model defined in OpenAPI

        Args:
            data ([CapabilityDefinition]): List of capabilities
