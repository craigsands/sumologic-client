...
def lazy_import():
    ...
    globals()['DimensionTransformation'] = DimensionTransformation


class TransformationRuleDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'dimension_transformations': ([DimensionTransformation],),  # noqa: E501
            'transformed_metrics_retention': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'dimension_transformations': 'dimensionTransformations',  # noqa: E501
        'transformed_metrics_retention': 'transformedMetricsRetention',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, selector, *args, **kwargs):  # noqa: E501
        """TransformationRuleDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            retention (int): Retention period in days for the metrics that are selected by the selector. The supported retention periods for selected metrics are 8 days, 400 days, and 0 (Do not store) if this rule contains dimension transformation.. defaults to 400  # noqa: E501
            ...
            dimension_transformations ([DimensionTransformation]): Dimension transformations of the transformation rule.. [optional] if omitted the server will use the default value of []  # noqa: E501
        ...
        retention = kwargs.get('retention', 400)
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, selector, *args, **kwargs):  # noqa: E501
        """TransformationRuleDefinition - a model defined in OpenAPI
