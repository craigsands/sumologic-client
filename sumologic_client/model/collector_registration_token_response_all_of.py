...
class CollectorRegistrationTokenResponseAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, encoded_token_and_url, *args, **kwargs):  # noqa: E501
        """CollectorRegistrationTokenResponseAllOf - a model defined in OpenAPI
        ...
        self.encoded_token_and_url = encoded_token_and_url
    ...
    @convert_js_args_to_python_args
    def __init__(self, encoded_token_and_url, *args, **kwargs):  # noqa: E501
        """CollectorRegistrationTokenResponseAllOf - a model defined in OpenAPI
