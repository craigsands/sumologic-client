...
class DashboardSearchStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'state': (str,),  # noqa: E501
            'percent_completed': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'percent_completed': 'percentCompleted',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, state, *args, **kwargs):  # noqa: E501
        """DashboardSearchStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            percent_completed (int): Percentage of search completed.. [optional]  # noqa: E501
        """
