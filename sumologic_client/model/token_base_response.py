...
def lazy_import():
    ...
    globals()['CollectorRegistrationTokenResponse'] = CollectorRegistrationTokenResponse


class TokenBaseResponse(ModelNormal):
    ...
    validations = {
        ...
        ('status',): {
            'regex': {
                'pattern': r'^(Active|Inactive)$',  # noqa: E501
            },
        },
        ('type',): {
            'regex': {
                'pattern': r'^(CollectorRegistrationTokenResponse)$',  # noqa: E501
            },
        },
    }
    ...
    def discriminator():
        lazy_import()
        val = {
            'CollectorRegistrationTokenResponse': CollectorRegistrationTokenResponse,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, status, type, version, created_at, created_by, modified_at, modified_by, *args, **kwargs):  # noqa: E501
        """TokenBaseResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, status, type, version, created_at, created_by, modified_at, modified_by, *args, **kwargs):  # noqa: E501
        """TokenBaseResponse - a model defined in OpenAPI
