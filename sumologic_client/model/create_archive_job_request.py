...
class CreateArchiveJobRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, start_time, end_time, *args, **kwargs):  # noqa: E501
        """CreateArchiveJobRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, start_time, end_time, *args, **kwargs):  # noqa: E501
        """CreateArchiveJobRequest - a model defined in OpenAPI
