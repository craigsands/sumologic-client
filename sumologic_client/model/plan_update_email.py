...
def lazy_import():
    ...
    globals()['SelfServiceCreditsBaselines'] = SelfServiceCreditsBaselines


class PlanUpdateEmail(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'baselines': (SelfServiceCreditsBaselines,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email_id, baselines, *args, **kwargs):  # noqa: E501
        """PlanUpdateEmail - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            phone_number (str): contact number on which support team can call user. [optional]  # noqa: E501
            billing_frequency (str): The frequency with with the customer needs to be billed at. The current supported values are Monthly and Annually. [optional]  # noqa: E501
            details (str): option details the user might want to inform. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, email_id, baselines, *args, **kwargs):  # noqa: E501
        """PlanUpdateEmail - a model defined in OpenAPI
