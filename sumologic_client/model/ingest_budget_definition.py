...
class IngestBudgetDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, field_value, capacity_bytes, timezone, reset_time, action, *args, **kwargs):  # noqa: E501
        """IngestBudgetDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, field_value, capacity_bytes, timezone, reset_time, action, *args, **kwargs):  # noqa: E501
        """IngestBudgetDefinition - a model defined in OpenAPI
