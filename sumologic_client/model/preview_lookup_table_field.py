...
class PreviewLookupTableField(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, field_name, field_type, field_id, *args, **kwargs):  # noqa: E501
        """PreviewLookupTableField - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, field_name, field_type, field_id, *args, **kwargs):  # noqa: E501
        """PreviewLookupTableField - a model defined in OpenAPI
