...
class WebhookConnectionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, headers, custom_headers, default_payload, webhook_type, *args, **kwargs):  # noqa: E501
        """WebhookConnectionAllOf - a model defined in OpenAPI

        Args:
            url (str): URL for the webhook connection.
            headers ([Header]): List of access authorization headers.
            custom_headers ([Header]): List of custom webhook headers.
            default_payload (str): Default payload of the webhook.
            webhook_type (ConnectionType):
        ...
        Keyword Args:
            ...
            warnings ([str]): Webhook endpoint warning for incorrect variable names and syntax.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, headers, custom_headers, default_payload, webhook_type, *args, **kwargs):  # noqa: E501
        """WebhookConnectionAllOf - a model defined in OpenAPI
