...
def lazy_import():
    ...
    globals()['CreateUserDefinition'] = CreateUserDefinition
    globals()['MetadataModel'] = MetadataModel
    globals()['UserModelAllOf'] = UserModelAllOf


class UserModel(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'last_login_timestamp': (datetime,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'last_login_timestamp': 'lastLoginTimestamp',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_active (bool): True if the user is active.. [optional]  # noqa: E501
            is_locked (bool): This has the value `true` if the user's account has been locked. If a user tries to log into their account several times and fails, his or her account will be locked for security reasons.. [optional]  # noqa: E501
            is_mfa_enabled (bool): True if multi factor authentication is enabled for the user.. [optional]  # noqa: E501
            last_login_timestamp (datetime): Timestamp of the last login for the user in UTC. Will be null if the user has never logged in.. [optional]  # noqa: E501
        """
