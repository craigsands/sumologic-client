...
class VisualAggregateData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, max, min, avg, sum, latest, *args, **kwargs):  # noqa: E501
        """VisualAggregateData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (float): The number of values in the series.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, max, min, avg, sum, latest, *args, **kwargs):  # noqa: E501
        """VisualAggregateData - a model defined in OpenAPI
