...
class MetadataVariableSourceDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filter, key, *args, **kwargs):  # noqa: E501
        """MetadataVariableSourceDefinitionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filter, key, *args, **kwargs):  # noqa: E501
        """MetadataVariableSourceDefinitionAllOf - a model defined in OpenAPI
