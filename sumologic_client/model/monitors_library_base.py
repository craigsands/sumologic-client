...
def lazy_import():
    ...
    globals()['MonitorsLibraryFolder'] = MonitorsLibraryFolder
    globals()['MonitorsLibraryMonitor'] = MonitorsLibraryMonitor


class MonitorsLibraryBase(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MonitorsLibraryFolder': MonitorsLibraryFolder,
            'MonitorsLibraryMonitor': MonitorsLibraryMonitor,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBase - a model defined in OpenAPI
