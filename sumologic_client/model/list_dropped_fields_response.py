...
def lazy_import():
    ...
    globals()['DroppedField'] = DroppedField


class ListDroppedFieldsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListDroppedFieldsResponse - a model defined in OpenAPI

        Args:
            data ([DroppedField]): List of dropped fields.
