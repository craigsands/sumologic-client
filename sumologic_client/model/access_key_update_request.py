...
class AccessKeyUpdateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, disabled, *args, **kwargs):  # noqa: E501
        """AccessKeyUpdateRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, disabled, *args, **kwargs):  # noqa: E501
        """AccessKeyUpdateRequest - a model defined in OpenAPI
