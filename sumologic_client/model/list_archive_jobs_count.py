...
def lazy_import():
    ...
    globals()['ArchiveJobsCount'] = ArchiveJobsCount


class ListArchiveJobsCount(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ArchiveJobsCount],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListArchiveJobsCount - a model defined in OpenAPI

        Args:
            data ([ArchiveJobsCount]): List of archive sources with count of jobs having various statuses.
