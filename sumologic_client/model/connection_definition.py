...
def lazy_import():
    ...
    globals()['ServiceNowDefinition'] = ServiceNowDefinition
    globals()['WebhookDefinition'] = WebhookDefinition


class ConnectionDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, type, name, *args, **kwargs):  # noqa: E501
        """ConnectionDefinition - a model defined in OpenAPI
