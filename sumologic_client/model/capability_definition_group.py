...
class CapabilityDefinitionGroup(ModelNormal):
    ...
    def _from_openapi_data(cls, id, label, *args, **kwargs):  # noqa: E501
        """CapabilityDefinitionGroup - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            parent_id (str): The ID of the parent capability group. [optional]  # noqa: E501
        """
