...
class BulkErrorResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, status, error_response, *args, **kwargs):  # noqa: E501
        """BulkErrorResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, error_response, *args, **kwargs):  # noqa: E501
        """BulkErrorResponse - a model defined in OpenAPI
