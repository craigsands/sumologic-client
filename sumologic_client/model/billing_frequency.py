...
class BillingFrequency(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """BillingFrequency - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Identifier for the plans billing term. Valid values are:  1. Monthly  2. Annually .  # noqa: E501

        Keyword Args:
            value (str): Identifier for the plans billing term. Valid values are:  1. Monthly  2. Annually .  # noqa: E501
