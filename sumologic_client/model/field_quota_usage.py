...
class FieldQuotaUsage(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, quota, remaining, *args, **kwargs):  # noqa: E501
        """FieldQuotaUsage - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, quota, remaining, *args, **kwargs):  # noqa: E501
        """FieldQuotaUsage - a model defined in OpenAPI
