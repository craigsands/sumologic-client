...
class CreateScheduledViewDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query, index_name, start_time, *args, **kwargs):  # noqa: E501
        """CreateScheduledViewDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, query, index_name, start_time, *args, **kwargs):  # noqa: E501
        """CreateScheduledViewDefinition - a model defined in OpenAPI
