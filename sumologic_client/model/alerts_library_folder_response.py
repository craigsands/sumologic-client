...
def lazy_import():
    ...
    globals()['AlertsLibraryFolderResponseAllOf'] = AlertsLibraryFolderResponseAllOf


class AlertsLibraryFolderResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'children': ([AlertsLibraryBaseResponse],),  # noqa: E501
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AlertsLibraryFolderResponse - a model defined in OpenAPI

        Keyword Args:
            children ([AlertsLibraryBaseResponse]): Children of the folder. NOTE: Permissions field will not be filled (empty list) for children.
