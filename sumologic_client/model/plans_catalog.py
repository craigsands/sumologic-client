...
def lazy_import():
    ...
    globals()['SelfServicePlan'] = SelfServicePlan


class PlansCatalog(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'plans': ([SelfServicePlan],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, plans, *args, **kwargs):  # noqa: E501
        """PlansCatalog - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, plans, *args, **kwargs):  # noqa: E501
        """PlansCatalog - a model defined in OpenAPI
