...
def lazy_import():
    ...
    globals()['Grid'] = Grid
    globals()['LayoutStructure'] = LayoutStructure


class Layout(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'layout_type': (str,),  # noqa: E501
            'layout_structures': ([LayoutStructure],),  # noqa: E501
        }
    ...
    def discriminator():
        ...
        if not val:
            return None
        return {'layout_type': val}

    attribute_map = {
        'layout_type': 'layoutType',  # noqa: E501
        'layout_structures': 'layoutStructures',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, layout_type, layout_structures, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            layout_structures ([LayoutStructure]): Layout structures for the panel childen.
    ...
    @convert_js_args_to_python_args
    def __init__(self, layout_type, layout_structures, *args, **kwargs):  # noqa: E501
        """Layout - a model defined in OpenAPI
