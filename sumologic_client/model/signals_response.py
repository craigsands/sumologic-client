...
def lazy_import():
    ...
    globals()['OpenInQuery'] = OpenInQuery


class SignalsResponse(ModelNormal):
    ...
    validations = {
        ('signal_type',): {
            'regex': {
                'pattern': r'^(LogFluctuation|DimensionalityExplanation|GisBenchmark|Anomalies)$|^$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'open_in_queries': ([OpenInQuery],),  # noqa: E501
        }
    ...
    attribute_map = {
        'signal_type': 'signalType',  # noqa: E501
        ...
        'open_in_queries': 'openInQueries',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, signal_type, signal_id, start_time, end_time, summary, payload, open_in_queries, *args, **kwargs):  # noqa: E501
        """SignalsResponse - a model defined in OpenAPI
        ...
        Args:
            ...
            open_in_queries ([OpenInQuery]): Raw data queries for the computed signal.
        ...
        self.open_in_queries = open_in_queries
    ...
    @convert_js_args_to_python_args
    def __init__(self, signal_type, signal_id, start_time, end_time, summary, payload, open_in_queries, *args, **kwargs):  # noqa: E501
        """SignalsResponse - a model defined in OpenAPI
