...
def lazy_import():
    ...
    globals()['LogsOutlierConditionAllOf'] = LogsOutlierConditionAllOf
    globals()['OutlierDirection2'] = OutlierDirection2
    globals()['TriggerCondition'] = TriggerCondition


class LogsOutlierCondition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'window': (int,),  # noqa: E501
            'consecutive': (int,),  # noqa: E501
            'direction': (OutlierDirection2,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'consecutive': 'consecutive',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LogsOutlierCondition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            window (int): Sets the trailing number of data points to calculate mean and sigma.. [optional] if omitted the server will use the default value of 50  # noqa: E501
            consecutive (int): Sets the required number of consecutive indicator data points (outliers) to trigger a violation.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            direction (OutlierDirection2): [optional]  # noqa: E501
            threshold (float): Sets the number of standard deviations for calculating violations.. [optional] if omitted the server will use the default value of 3.0  # noqa: E501
            field (str): The name of the field that the trigger condition will alert on.. [optional]  # noqa: E501
