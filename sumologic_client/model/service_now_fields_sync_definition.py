...
class ServiceNowFieldsSyncDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ServiceNowFieldsSyncDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            event_type (str): The category that the event source uses to identify the event.. [optional]  # noqa: E501
            severity (int): An integer value representing the severity of the alert. Supported values are:   - `0` for Clear   - `1` for Critical   - `2` for Major   - `3` for Minor   - `4` for Warning. [optional]  # noqa: E501
            resource (str): The component on the node to which the event applies.. [optional]  # noqa: E501
            node (str): The physical or virtual device on which the event occurred.. [optional]  # noqa: E501
        """
