...
class AccessKeyPublic(ModelNormal):
    ...
    attribute_map = {
        ...
        'cors_headers': 'corsHeaders',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, label, disabled, created_at, created_by, modified_at, *args, **kwargs):  # noqa: E501
        """AccessKeyPublic - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, label, disabled, created_at, created_by, modified_at, *args, **kwargs):  # noqa: E501
        """AccessKeyPublic - a model defined in OpenAPI
