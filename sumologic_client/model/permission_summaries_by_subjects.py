...
def lazy_import():
    ...
    globals()['PermissionSummaryBySubjects'] = PermissionSummaryBySubjects


class PermissionSummariesBySubjects(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'permission_summaries_by_subjects': ([PermissionSummaryBySubjects],),  # noqa: E501
        }
    ...
    attribute_map = {
        'permission_summaries_by_subjects': 'permissionSummariesBySubjects',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_summaries_by_subjects, *args, **kwargs):  # noqa: E501
        """PermissionSummariesBySubjects - a model defined in OpenAPI

        Args:
            permission_summaries_by_subjects ([PermissionSummaryBySubjects]): A list of PermissionSubjects and PermissionSummaryMeta(s) associated with each subject.
        ...
        self.permission_summaries_by_subjects = permission_summaries_by_subjects
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_summaries_by_subjects, *args, **kwargs):  # noqa: E501
        """PermissionSummariesBySubjects - a model defined in OpenAPI
