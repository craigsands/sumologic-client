...
class RelationTypeTag(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """RelationTypeTag - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): The nature of the relationship between alerts. Valid values:   1. `Time`: Alerts are related by their time of creation.   2. `Entity`: Alerts are related by the entities linked to their queries..  # noqa: E501

        Keyword Args:
            value (str): The nature of the relationship between alerts. Valid values:   1. `Time`: Alerts are related by their time of creation.   2. `Entity`: Alerts are related by the entities linked to their queries..  # noqa: E501
