...
def lazy_import():
    ...
    globals()['LookupTableAllOf'] = LookupTableAllOf
    globals()['LookupTableDefinition'] = LookupTableDefinition
    globals()['LookupTableField'] = LookupTableField
    globals()['MetadataModel'] = MetadataModel


class LookupTable(ModelComposed):
    ...
    validations = {
        ...
        ('size_limit_action',): {
            'regex': {
                'pattern': r'^(StopIncomingMessages|DeleteOldData)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'fields': ([LookupTableField],),  # noqa: E501
            'primary_keys': ([str],),  # noqa: E501
            'name': (str,),  # noqa: E501
            'parent_folder_id': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'ttl': (int,),  # noqa: E501
            'size_limit_action': (str,),  # noqa: E501
            'content_path': (str,),  # noqa: E501
            'size': (int,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'id': 'id',  # noqa: E501
        'ttl': 'ttl',  # noqa: E501
        'size_limit_action': 'sizeLimitAction',  # noqa: E501
        'content_path': 'contentPath',  # noqa: E501
        'size': 'size',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LookupTable - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            fields ([LookupTableField]): The list of fields in the lookup table.
            ...
            ttl (int): A time to live for each entry in the lookup table (in minutes). 365 days is the maximum time to live for each entry that you can specify. Setting it to 0 means that the records will not expire automatically.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            size_limit_action (str): The action that needs to be taken when the size limit is reached for the table. The possible values can be `StopIncomingMessages` or `DeleteOldData`. DeleteOldData will start deleting old data once size limit is reached whereas StopIncomingMessages will discard all the updates made to the lookup table once size limit is reached.. [optional] if omitted the server will use the default value of "StopIncomingMessages"  # noqa: E501
            content_path (str): Address/path of the parent folder of this lookup table in content library. For example, a lookup table existing  in the personal/lookupTable folder for user johndoe would be: /Library/Users/johndoe@acme.com/lookupTable. [optional]  # noqa: E501
            size (int): The current size of the lookup table in bytes. [optional]  # noqa: E501
        """
