...
class Operator(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, values, name, *args, **kwargs):  # noqa: E501
        """Operator - a model defined in OpenAPI

        Args:
            values ([DataValue]): An array of objects denoting the value and unit of the results.
    ...
    @convert_js_args_to_python_args
    def __init__(self, values, name, *args, **kwargs):  # noqa: E501
        """Operator - a model defined in OpenAPI
