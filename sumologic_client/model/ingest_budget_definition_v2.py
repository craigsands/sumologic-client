...
class IngestBudgetDefinitionV2(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, scope, capacity_bytes, timezone, reset_time, action, *args, **kwargs):  # noqa: E501
        """IngestBudgetDefinitionV2 - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, scope, capacity_bytes, timezone, reset_time, action, *args, **kwargs):  # noqa: E501
        """IngestBudgetDefinitionV2 - a model defined in OpenAPI
