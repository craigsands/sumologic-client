...
class SubdomainDefinitionResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, created_by, modified_at, modified_by, subdomain, url, *args, **kwargs):  # noqa: E501
        """SubdomainDefinitionResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, created_by, modified_at, modified_by, subdomain, url, *args, **kwargs):  # noqa: E501
        """SubdomainDefinitionResponse - a model defined in OpenAPI
