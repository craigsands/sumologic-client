...
def lazy_import():
    ...
    globals()['PathItem'] = PathItem


class Path(ModelNormal):
    ...
    attribute_map = {
        'path_items': 'pathItems',  # noqa: E501
        'path': 'path',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, path_items, path, *args, **kwargs):  # noqa: E501
        """Path - a model defined in OpenAPI

        Args:
            path_items ([PathItem]): Elements of the path.
    ...
    @convert_js_args_to_python_args
    def __init__(self, path_items, path, *args, **kwargs):  # noqa: E501
        """Path - a model defined in OpenAPI
