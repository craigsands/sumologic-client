...
class AlertMonitorQueryAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, is_trigger_row, *args, **kwargs):  # noqa: E501
        """AlertMonitorQueryAllOf - a model defined in OpenAPI
        ...
        self.is_trigger_row = is_trigger_row
    ...
    @convert_js_args_to_python_args
    def __init__(self, is_trigger_row, *args, **kwargs):  # noqa: E501
        """AlertMonitorQueryAllOf - a model defined in OpenAPI
