...
def lazy_import():
    ...
    globals()['TableRow'] = TableRow


class RowDeleteDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'primary_key': ([TableRow],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, primary_key, *args, **kwargs):  # noqa: E501
        """RowDeleteDefinition - a model defined in OpenAPI

        Args:
            primary_key ([TableRow]): A list of all primary key field identifiers and their corresponding values.
    ...
    @convert_js_args_to_python_args
    def __init__(self, primary_key, *args, **kwargs):  # noqa: E501
        """RowDeleteDefinition - a model defined in OpenAPI
