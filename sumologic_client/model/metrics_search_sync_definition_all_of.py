...
class MetricsSearchSyncDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time_range, queries, *args, **kwargs):  # noqa: E501
        """MetricsSearchSyncDefinitionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time_range, queries, *args, **kwargs):  # noqa: E501
        """MetricsSearchSyncDefinitionAllOf - a model defined in OpenAPI
