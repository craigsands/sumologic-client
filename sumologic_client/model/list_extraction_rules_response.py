...
def lazy_import():
    ...
    globals()['ExtractionRule'] = ExtractionRule


class ListExtractionRulesResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListExtractionRulesResponse - a model defined in OpenAPI
