...
def lazy_import():
    ...
    globals()['BuiltinField'] = BuiltinField


class ListBuiltinFieldsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListBuiltinFieldsResponse - a model defined in OpenAPI

        Args:
            data ([BuiltinField]): List of built-in fields.
