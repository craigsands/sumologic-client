...
class TransformationRuleRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, rule_definition, enabled, *args, **kwargs):  # noqa: E501
        """TransformationRuleRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, rule_definition, enabled, *args, **kwargs):  # noqa: E501
        """TransformationRuleRequest - a model defined in OpenAPI
