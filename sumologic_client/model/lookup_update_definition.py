...
class LookupUpdateDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, description, *args, **kwargs):  # noqa: E501
        """LookupUpdateDefinition - a model defined in OpenAPI

        Args:
            description (str): The description of the lookup table. The description cannot be blank.

        Keyword Args:
            ttl (int): A time to live for each entry in the lookup table (in minutes). 0 is a special value. A TTL of 0 implies entry will never be deleted from the table.. defaults to 0  # noqa: E501
