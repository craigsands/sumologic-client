...
class Capacity(ModelNormal):
    ...
    attribute_map = {
        ...
        'unit': 'unit',  # noqa: E501
        'capacity_type': 'capacityType',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, value, unit, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            capacity_type (str): Type of capacity. Valid values are: 1) `Paid` : This means that the capacity is chargeable. 2) `Free` : This means that this capacity is not chargeable.. [optional]  # noqa: E501
        """
