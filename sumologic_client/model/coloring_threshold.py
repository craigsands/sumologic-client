...
class ColoringThreshold(ModelNormal):
    ...
    def _from_openapi_data(cls, color, *args, **kwargs):  # noqa: E501
        """ColoringThreshold - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            min (float): Absolute inclusive threshold to color by.. [optional]  # noqa: E501
            max (float): Absolute exclusive threshold to color by.. [optional]  # noqa: E501
        """
