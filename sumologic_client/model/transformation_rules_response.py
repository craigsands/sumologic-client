...
def lazy_import():
    ...
    globals()['TransformationRuleResponse'] = TransformationRuleResponse


class TransformationRulesResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([TransformationRuleResponse],),  # noqa: E501
            'next': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TransformationRulesResponse - a model defined in OpenAPI

        Args:
            data ([TransformationRuleResponse]): List of transformation rules.
