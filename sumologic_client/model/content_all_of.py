...
class ContentAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, item_type, parent_id, permissions, *args, **kwargs):  # noqa: E501
        """ContentAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, item_type, parent_id, permissions, *args, **kwargs):  # noqa: E501
        """ContentAllOf - a model defined in OpenAPI
