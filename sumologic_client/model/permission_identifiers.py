...
def lazy_import():
    ...
    globals()['PermissionIdentifier'] = PermissionIdentifier


class PermissionIdentifiers(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'permission_identifiers': ([PermissionIdentifier],),  # noqa: E501
        }
    ...
    attribute_map = {
        'permission_identifiers': 'permissionIdentifiers',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_identifiers, *args, **kwargs):  # noqa: E501
        """PermissionIdentifiers - a model defined in OpenAPI

        Args:
            permission_identifiers ([PermissionIdentifier]): List of permission identifiers.
        ...
        self.permission_identifiers = permission_identifiers
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_identifiers, *args, **kwargs):  # noqa: E501
        """PermissionIdentifiers - a model defined in OpenAPI
