...
class OpenInQuery(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query, start_time, end_time, *args, **kwargs):  # noqa: E501
        """OpenInQuery - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, query, start_time, end_time, *args, **kwargs):  # noqa: E501
        """OpenInQuery - a model defined in OpenAPI
