...
def lazy_import():
    ...
    globals()['MetricsOutlierConditionAllOf'] = MetricsOutlierConditionAllOf
    globals()['OutlierDirection2'] = OutlierDirection2
    globals()['TriggerCondition'] = TriggerCondition


class MetricsOutlierCondition(ModelComposed):
    ...
    attribute_map = {
        ...
        'baseline_window': 'baselineWindow',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MetricsOutlierCondition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            baseline_window (str): The time range used to compute the baseline.. [optional] if omitted the server will use the default value of "1d"  # noqa: E501
            direction (OutlierDirection2): [optional]  # noqa: E501
            threshold (float): How much should the indicator be different from the baseline for each datapoint.. [optional] if omitted the server will use the default value of 3.0  # noqa: E501
