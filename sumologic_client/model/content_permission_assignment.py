...
class ContentPermissionAssignment(ModelNormal):
    ...
    validations = {
        ('permission_name',): {
            'regex': {
                'pattern': r'^(View|GrantView|Edit|GrantEdit|Manage|GrantManage)$',  # noqa: E501
            },
        },
        ('source_type',): {
            'regex': {
                'pattern': r'^(user|role|org)$',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_name, source_type, source_id, content_id, *args, **kwargs):  # noqa: E501
        """ContentPermissionAssignment - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_name, source_type, source_id, content_id, *args, **kwargs):  # noqa: E501
        """ContentPermissionAssignment - a model defined in OpenAPI
