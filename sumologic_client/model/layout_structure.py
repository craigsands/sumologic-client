...
class LayoutStructure(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, structure, *args, **kwargs):  # noqa: E501
        """LayoutStructure - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, structure, *args, **kwargs):  # noqa: E501
        """LayoutStructure - a model defined in OpenAPI
