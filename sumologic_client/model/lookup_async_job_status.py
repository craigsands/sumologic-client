...
def lazy_import():
    ...
    globals()['WarningDescription'] = WarningDescription


class LookupAsyncJobStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'lookup_content_id': (str,),  # noqa: E501
            'lookup_name': (str,),  # noqa: E501
            'lookup_content_path': (str,),  # noqa: E501
            'user_id': (str,),  # noqa: E501
            'created_at': (datetime,),  # noqa: E501
            'modified_at': (datetime,),  # noqa: E501
            'status_messages': ([str],),  # noqa: E501
            'errors': ([ErrorDescription],),  # noqa: E501
            'warnings': ([WarningDescription],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'lookup_content_id': 'lookupContentId',  # noqa: E501
        'lookup_name': 'lookupName',  # noqa: E501
        'lookup_content_path': 'lookupContentPath',  # noqa: E501
        'user_id': 'userId',  # noqa: E501
        'created_at': 'createdAt',  # noqa: E501
        'modified_at': 'modifiedAt',  # noqa: E501
        'status_messages': 'statusMessages',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job_id, status, lookup_content_id, lookup_name, lookup_content_path, user_id, created_at, modified_at, *args, **kwargs):  # noqa: E501
        """LookupAsyncJobStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            status_messages ([str]): Additional status messages generated if any if the status is `Success`.. [optional]  # noqa: E501
            errors ([ErrorDescription]): More information about the failures, if the status is `Failed`.. [optional]  # noqa: E501
            warnings ([WarningDescription]): More information about the warnings, if the status is `PartialSuccess`.. [optional]  # noqa: E501
            request_type (str): Type of asynchronous request made:   - `BulkMerge`   - `BulkReplace`   - `Truncate`. [optional]  # noqa: E501
        """
        ...
        self.job_id = job_id
        self.status = status
        self.lookup_content_id = lookup_content_id
        self.lookup_name = lookup_name
        self.lookup_content_path = lookup_content_path
    ...
    @convert_js_args_to_python_args
    def __init__(self, job_id, status, lookup_content_id, lookup_name, lookup_content_path, user_id, created_at, modified_at, *args, **kwargs):  # noqa: E501
        """LookupAsyncJobStatus - a model defined in OpenAPI
