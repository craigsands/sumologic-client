...
def lazy_import():
    ...
    globals()['LogsMissingDataCondition'] = LogsMissingDataCondition
    globals()['LogsOutlierCondition'] = LogsOutlierCondition
    globals()['LogsStaticCondition'] = LogsStaticCondition
    globals()['MetricsMissingDataCondition'] = MetricsMissingDataCondition
    globals()['MetricsOutlierCondition'] = MetricsOutlierCondition
    globals()['MetricsStaticCondition'] = MetricsStaticCondition
    globals()['StaticCondition'] = StaticCondition


class TriggerCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trigger_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, trigger_type, *args, **kwargs):  # noqa: E501
        """TriggerCondition - a model defined in OpenAPI
