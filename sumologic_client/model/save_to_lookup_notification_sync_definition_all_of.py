...
class SaveToLookupNotificationSyncDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, lookup_file_path, is_lookup_merge_operation, *args, **kwargs):  # noqa: E501
        """SaveToLookupNotificationSyncDefinitionAllOf - a model defined in OpenAPI
        ...
        self.is_lookup_merge_operation = is_lookup_merge_operation
    ...
    @convert_js_args_to_python_args
    def __init__(self, lookup_file_path, is_lookup_merge_operation, *args, **kwargs):  # noqa: E501
        """SaveToLookupNotificationSyncDefinitionAllOf - a model defined in OpenAPI
