...
def lazy_import():
    ...
    globals()['AppListItem'] = AppListItem


class AppItemsList(ModelNormal):
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """AppItemsList - a model defined in OpenAPI

        Args:
            items ([AppListItem]): Items associated with the app.
