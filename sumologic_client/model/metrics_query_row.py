...
class MetricsQueryRow(ModelNormal):
    ...
    validations = {
        ...
        ('rollup',): {
            'regex': {
                'pattern': r'^(Count|Min|Max|Sum|Avg|None)$|^$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'query': (str,),  # noqa: E501
            'quantization': (int,),  # noqa: E501
            'rollup': (str,),  # noqa: E501
            'timeshift': (int,),  # noqa: E501
            'transient': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'timeshift': 'timeshift',  # noqa: E501
        'transient': 'transient',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, row_id, query, *args, **kwargs):  # noqa: E501
        """MetricsQueryRow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            quantization (int): Segregates time series data by time period. This allows you to create aggregated results in buckets of fixed intervals (for example, 5-minute intervals). The value is in milliseconds.. [optional]  # noqa: E501
            rollup (str): We use the term rollup to refer to the aggregation function Sumo Logic uses when quantizing metrics. Can be `Avg`, `Sum`, `Min`, `Max`, `Count` or `None`.. [optional]  # noqa: E501
            timeshift (int): Shifts the time series from your metrics query by the specified amount of time. This can help when comparing a time series across multiple time periods. Specified as a signed duration in milliseconds.. [optional]  # noqa: E501
            transient (bool): Determines if the row should be returned in the response. Can be used in conjunction with a join, if only the result of the join is needed, and not the intermediate rows.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, row_id, query, *args, **kwargs):  # noqa: E501
        """MetricsQueryRow - a model defined in OpenAPI
