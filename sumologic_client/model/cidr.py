...
class Cidr(ModelNormal):
    ...
    validations = {
        ('cidr',): {
            'regex': {
                'pattern': r'^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/([0-9]|[1-2][0-9]|3[0-2]))?$',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cidr, *args, **kwargs):  # noqa: E501
        """Cidr - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the CIDR notation or IP address.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, cidr, *args, **kwargs):  # noqa: E501
        """Cidr - a model defined in OpenAPI
