...
def lazy_import():
    ...
    globals()['PermissionStatement'] = PermissionStatement


class PermissionStatements(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'permission_statements': ([PermissionStatement],),  # noqa: E501
        }
    ...
    attribute_map = {
        'permission_statements': 'permissionStatements',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_statements, *args, **kwargs):  # noqa: E501
        """PermissionStatements - a model defined in OpenAPI

        Args:
            permission_statements ([PermissionStatement]): A list of permission statements.
        ...
        self.permission_statements = permission_statements
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_statements, *args, **kwargs):  # noqa: E501
        """PermissionStatements - a model defined in OpenAPI
