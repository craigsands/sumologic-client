...
class TopologySearchLabel(ModelNormal):
    ...
    def _from_openapi_data(cls, key, value, *args, **kwargs):  # noqa: E501
        """TopologySearchLabel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_required (bool): Whether the content item is required to contain this label in order to be matched. If true, content items without this label will not be matched. If false, content items without this label will be matched. . [optional]  # noqa: E501
        """
