...
def lazy_import():
    ...
    globals()['AppDefinition'] = AppDefinition
    globals()['AppManifest'] = AppManifest
...
class App(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'app_definition': (AppDefinition,),  # noqa: E501
            'app_manifest': (AppManifest,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, app_definition, app_manifest, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, app_definition, app_manifest, *args, **kwargs):  # noqa: E501
        """App - a model defined in OpenAPI
