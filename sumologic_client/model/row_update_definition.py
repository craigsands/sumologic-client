...
class RowUpdateDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, row, *args, **kwargs):  # noqa: E501
        """RowUpdateDefinition - a model defined in OpenAPI

        Args:
            row ([TableRow]): A list of all the field identifiers and their corresponding values.
    ...
    @convert_js_args_to_python_args
    def __init__(self, row, *args, **kwargs):  # noqa: E501
        """RowUpdateDefinition - a model defined in OpenAPI
