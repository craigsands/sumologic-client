...
class TokenBaseDefinitionUpdate(ModelNormal):
    ...
    validations = {
        ...
        ('type',): {
            'regex': {
                'pattern': r'^(CollectorRegistration)$',  # noqa: E501
            },
        },
        ('description',): {
            'max_length': 4096,
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, status, type, version, *args, **kwargs):  # noqa: E501
        """TokenBaseDefinitionUpdate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the token.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, status, type, version, *args, **kwargs):  # noqa: E501
        """TokenBaseDefinitionUpdate - a model defined in OpenAPI
