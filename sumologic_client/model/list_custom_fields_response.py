...
class ListCustomFieldsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListCustomFieldsResponse - a model defined in OpenAPI

        Args:
            data ([CustomField]): List of custom fields.
