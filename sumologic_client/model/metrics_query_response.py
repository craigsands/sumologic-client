...
def lazy_import():
    ...
    globals()['TimeSeriesRow'] = TimeSeriesRow
...
class MetricsQueryResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'query_result': ([TimeSeriesRow],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, errors, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            query_result ([TimeSeriesRow]): A list of the time series returned by metric query.. [optional]  # noqa: E501
        """
