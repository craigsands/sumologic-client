...
class ListAppsResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, apps, *args, **kwargs):  # noqa: E501
        """ListAppsResult - a model defined in OpenAPI

        Args:
            apps ([App]): An array of Apps
    ...
    @convert_js_args_to_python_args
    def __init__(self, apps, *args, **kwargs):  # noqa: E501
        """ListAppsResult - a model defined in OpenAPI
