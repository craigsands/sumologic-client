...
class SecondaryKeysDefinition(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SecondaryKeysDefinition - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([[str]]): The secondary keys of the lookup table.  # noqa: E501

        Keyword Args:
            value ([[str]]): The secondary keys of the lookup table.  # noqa: E501
