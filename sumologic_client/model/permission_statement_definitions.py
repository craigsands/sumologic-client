...
def lazy_import():
    ...
    globals()['PermissionStatementDefinition'] = PermissionStatementDefinition


class PermissionStatementDefinitions(ModelNormal):
    ...
    validations = {
        ('permission_statement_definitions',): {
            'max_items': 1000,
            'min_items': 1,
        },
    }
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'permission_statement_definitions': ([PermissionStatementDefinition],),  # noqa: E501
        }
    ...
    attribute_map = {
        'permission_statement_definitions': 'permissionStatementDefinitions',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_statement_definitions, *args, **kwargs):  # noqa: E501
        """PermissionStatementDefinitions - a model defined in OpenAPI

        Args:
            permission_statement_definitions ([PermissionStatementDefinition]): List of permission statement definitions.
        ...
        self.permission_statement_definitions = permission_statement_definitions
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_statement_definitions, *args, **kwargs):  # noqa: E501
        """PermissionStatementDefinitions - a model defined in OpenAPI
