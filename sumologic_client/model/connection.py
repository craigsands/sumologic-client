...
def lazy_import():
    ...
    globals()['ServiceNowConnection'] = ServiceNowConnection
    globals()['WebhookConnection'] = WebhookConnection
...
class Connection(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, id, name, description, created_at, created_by, modified_at, modified_by, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, id, name, description, created_at, created_by, modified_at, modified_by, *args, **kwargs):  # noqa: E501
        """Connection - a model defined in OpenAPI
