...
def lazy_import():
    ...
    globals()['AlertsLibraryAlert'] = AlertsLibraryAlert
    globals()['AlertsLibraryFolder'] = AlertsLibraryFolder


class AlertsLibraryBase(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AlertsLibraryAlert': AlertsLibraryAlert,
            'AlertsLibraryFolder': AlertsLibraryFolder,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """AlertsLibraryBase - a model defined in OpenAPI
