...
def lazy_import():
    ...
    globals()['TopologyLabelValuesList'] = TopologyLabelValuesList


class TopologyLabelMap(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ({str: (TopologyLabelValuesList,)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """TopologyLabelMap - a model defined in OpenAPI

        Args:
            data ({str: (TopologyLabelValuesList,)}): Map from topology labels to `TopologyLabelValuesList`.
