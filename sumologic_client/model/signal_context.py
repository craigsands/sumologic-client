...
class SignalContext(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'AlertSignalContext': AlertSignalContext,
        }
        if not val:
            return None
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, context_type, *args, **kwargs):  # noqa: E501
        """SignalContext - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, context_type, *args, **kwargs):  # noqa: E501
        """SignalContext - a model defined in OpenAPI
