...
class ServiceNowDefinitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, username, password, *args, **kwargs):  # noqa: E501
        """ServiceNowDefinitionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, username, password, *args, **kwargs):  # noqa: E501
        """ServiceNowDefinitionAllOf - a model defined in OpenAPI
