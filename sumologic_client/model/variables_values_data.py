...
def lazy_import():
    ...
    globals()['VariableValuesData'] = VariableValuesData


class VariablesValuesData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'rich_data': ({str: (VariableValuesData,)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VariablesValuesData - a model defined in OpenAPI

        Args:

        Keyword Args:
            data ({str: ([str],)}): Data for variable values.. defaults to {}  # noqa: E501
            ...
            rich_data ({str: (VariableValuesData,)}): A rich form of data for the variable search, including variable values, status and variable type. This field is different from `data` in that it includes an object instead of list as the value in the map. The `data` field is kept for backwards compatibility, please use `richData` for all usages going forward.. [optional]  # noqa: E501
        """
