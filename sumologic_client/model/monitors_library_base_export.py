...
def lazy_import():
    ...
    globals()['MonitorsLibraryFolderExport'] = MonitorsLibraryFolderExport
    globals()['MonitorsLibraryMonitorExport'] = MonitorsLibraryMonitorExport


class MonitorsLibraryBaseExport(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MonitorsLibraryFolderExport': MonitorsLibraryFolderExport,
            'MonitorsLibraryMonitorExport': MonitorsLibraryMonitorExport,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBaseExport - a model defined in OpenAPI
