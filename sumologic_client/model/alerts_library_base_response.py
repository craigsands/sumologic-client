...
def lazy_import():
    ...
    globals()['AlertsLibraryAlertResponse'] = AlertsLibraryAlertResponse
    globals()['AlertsLibraryFolderResponse'] = AlertsLibraryFolderResponse


class AlertsLibraryBaseResponse(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AlertsLibraryAlertResponse': AlertsLibraryAlertResponse,
            'AlertsLibraryFolderResponse': AlertsLibraryFolderResponse,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, id, name, description, version, created_at, created_by, modified_at, modified_by, parent_id, content_type, type, is_system, is_mutable, *args, **kwargs):  # noqa: E501
        """AlertsLibraryBaseResponse - a model defined in OpenAPI
