...
def lazy_import():
    ...
    globals()['CapabilityDefinition'] = CapabilityDefinition


class CapabilityMap(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'capabilities': ({str: (CapabilityDefinition,)},),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, capabilities, *args, **kwargs):  # noqa: E501
        """CapabilityMap - a model defined in OpenAPI

        Args:
            capabilities ({str: (CapabilityDefinition,)}): Map of capabilities to their attributes
