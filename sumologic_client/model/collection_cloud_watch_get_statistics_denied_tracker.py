...
def lazy_import():
    ...
    globals()['AwsCloudWatchCollectionErrorTracker'] = AwsCloudWatchCollectionErrorTracker
    globals()['CollectionCloudWatchListMetricsDeniedTrackerAllOf'] = CollectionCloudWatchListMetricsDeniedTrackerAllOf
    globals()['TrackerIdentity'] = TrackerIdentity


class CollectionCloudWatchGetStatisticsDeniedTracker(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollectionCloudWatchGetStatisticsDeniedTracker - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            error_code (str): The error code from AWS for the request made to get metrics.. [optional]  # noqa: E501
            error_message (str): The error message from AWS for the request made to get metrics.. [optional]  # noqa: E501
        """
