...
class EpochTimeRangeBoundaryAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, epoch_millis, *args, **kwargs):  # noqa: E501
        """EpochTimeRangeBoundaryAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, epoch_millis, *args, **kwargs):  # noqa: E501
        """EpochTimeRangeBoundaryAllOf - a model defined in OpenAPI
