...
def lazy_import():
    ...
    globals()['MetricDefinition'] = MetricDefinition
...
class TimeSeries(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'metric_definition': (MetricDefinition,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metric_definition, points, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, metric_definition, points, *args, **kwargs):  # noqa: E501
        """TimeSeries - a model defined in OpenAPI
