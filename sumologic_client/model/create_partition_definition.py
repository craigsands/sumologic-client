...
class CreatePartitionDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, routing_expression, *args, **kwargs):  # noqa: E501
        """CreatePartitionDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, routing_expression, *args, **kwargs):  # noqa: E501
        """CreatePartitionDefinition - a model defined in OpenAPI
