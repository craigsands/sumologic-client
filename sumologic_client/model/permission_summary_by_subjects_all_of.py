...
class PermissionSummaryBySubjectsAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, permission_summaries, *args, **kwargs):  # noqa: E501
        """PermissionSummaryBySubjectsAllOf - a model defined in OpenAPI
        ...
        self.permission_summaries = permission_summaries
    ...
    @convert_js_args_to_python_args
    def __init__(self, permission_summaries, *args, **kwargs):  # noqa: E501
        """PermissionSummaryBySubjectsAllOf - a model defined in OpenAPI
