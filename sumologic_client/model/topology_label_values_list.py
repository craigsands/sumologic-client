...
class TopologyLabelValuesList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TopologyLabelValuesList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): List of values corresponding to a key of a label.. if omitted defaults to []  # noqa: E501

        Keyword Args:
            value ([str]): List of values corresponding to a key of a label.. if omitted defaults to []  # noqa: E501
