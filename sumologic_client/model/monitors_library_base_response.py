...
def lazy_import():
    ...
    globals()['MonitorsLibraryFolderResponse'] = MonitorsLibraryFolderResponse
    globals()['MonitorsLibraryMonitorResponse'] = MonitorsLibraryMonitorResponse


class MonitorsLibraryBaseResponse(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MonitorsLibraryFolderResponse': MonitorsLibraryFolderResponse,
            'MonitorsLibraryMonitorResponse': MonitorsLibraryMonitorResponse,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, description, version, created_at, created_by, modified_at, modified_by, parent_id, content_type, type, is_system, is_mutable, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBaseResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, description, version, created_at, created_by, modified_at, modified_by, parent_id, content_type, type, is_system, is_mutable, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBaseResponse - a model defined in OpenAPI
