...
class MetricsStaticConditionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time_range, threshold_type, occurrence_type, *args, **kwargs):  # noqa: E501
        """MetricsStaticConditionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time_range, threshold_type, occurrence_type, *args, **kwargs):  # noqa: E501
        """MetricsStaticConditionAllOf - a model defined in OpenAPI
