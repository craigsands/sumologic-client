...
def lazy_import():
    ...
    globals()['LogsStaticConditionAllOf'] = LogsStaticConditionAllOf
    globals()['StaticThresholdType'] = StaticThresholdType
    globals()['TriggerCondition'] = TriggerCondition


class LogsStaticCondition(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LogsStaticCondition - a model defined in OpenAPI

        Keyword Args:
            time_range (str): The relative time range of the monitor.
            threshold (float): The data value for the condition. This defines the threshold for when to trigger. Threshold value is not applicable for `MissingData` and `ResolvedMissingData` triggerTypes and will be ignored if specified.. defaults to 0.0  # noqa: E501
            threshold_type (StaticThresholdType):
