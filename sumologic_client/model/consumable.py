...
class Consumable(ModelNormal):
    ...
    validations = {
        ('consumable_id',): {
            'regex': {
                'pattern': r'^(Storage|Metrics|Continuous|Credits)$',  # noqa: E501
            },
        },
    }
    ...
    attribute_map = {
        'consumable_id': 'consumableId',  # noqa: E501
        'quantity': 'quantity',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, consumable_id, quantity, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, consumable_id, quantity, *args, **kwargs):  # noqa: E501
        """Consumable - a model defined in OpenAPI
