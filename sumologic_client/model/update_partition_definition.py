...
class UpdatePartitionDefinition(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdatePartitionDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            retention_period (int): The number of days to retain data in the partition, or -1 to use the default value for your account. Only relevant if your account has variable retention enabled.. [optional]  # noqa: E501
            ...
            routing_expression (str): The query that defines the data to be included in the partition.. [optional]  # noqa: E501
        """
