...
def lazy_import():
    ...
    globals()['CompleteLiteralTimeRangeAllOf'] = CompleteLiteralTimeRangeAllOf
    globals()['ResolvableTimeRange'] = ResolvableTimeRange


class CompleteLiteralTimeRange(ModelComposed):
    ...
    validations = {
        ('range_name',): {
            'regex': {
                'pattern': r'^(today|yesterday|previous_week|previous_month)$',  # noqa: E501
            },
        },
    }
    ...
    attribute_map = {
        'range_name': 'rangeName',  # noqa: E501
        'type': 'type',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CompleteLiteralTimeRange - a model defined in OpenAPI
