...
class LookupTableField(ModelNormal):
    ...
    validations = {
        ('field_type',): {
            'regex': {
                'pattern': r'^(boolean|int|long|double|string)$',  # noqa: E501
            },
        },
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, field_name, field_type, *args, **kwargs):  # noqa: E501
        """LookupTableField - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, field_name, field_type, *args, **kwargs):  # noqa: E501
        """LookupTableField - a model defined in OpenAPI
