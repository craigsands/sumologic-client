...
def lazy_import():
    ...
    globals()['ScheduledView'] = ScheduledView


class ListScheduledViewsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListScheduledViewsResponse - a model defined in OpenAPI

        Args:
            data ([ScheduledView]): List of scheduled views.
