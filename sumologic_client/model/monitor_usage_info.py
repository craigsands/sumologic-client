...
def lazy_import():
    ...
    globals()['MonitorUsage'] = MonitorUsage


class MonitorUsageInfo(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MonitorUsageInfo - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([MonitorUsage]): The usage info of logs and metrics monitors..  # noqa: E501

        Keyword Args:
            value ([MonitorUsage]): The usage info of logs and metrics monitors..  # noqa: E501
