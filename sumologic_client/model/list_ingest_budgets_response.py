...
def lazy_import():
    ...
    globals()['IngestBudget'] = IngestBudget


class ListIngestBudgetsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListIngestBudgetsResponse - a model defined in OpenAPI

        Args:
            data ([IngestBudget]): List of ingest budgets.
