...
def lazy_import():
    ...
    globals()['AddOrReplaceTransformation'] = AddOrReplaceTransformation
    globals()['AggregateOnTransformation'] = AggregateOnTransformation


class DimensionTransformation(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AddOrReplaceTransformation': AddOrReplaceTransformation,
            'AggregateOnTransformation': AggregateOnTransformation,
        }
        if not val:
            return None
        return {'transformation_type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transformation_type, *args, **kwargs):  # noqa: E501
        """DimensionTransformation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, transformation_type, *args, **kwargs):  # noqa: E501
        """DimensionTransformation - a model defined in OpenAPI
