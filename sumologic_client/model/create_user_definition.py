...
class CreateUserDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, first_name, last_name, email, role_ids, *args, **kwargs):  # noqa: E501
        """CreateUserDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, last_name, email, role_ids, *args, **kwargs):  # noqa: E501
        """CreateUserDefinition - a model defined in OpenAPI
