...
class ExportableLookupTableInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, description, fields, primary_keys, *args, **kwargs):  # noqa: E501
        """ExportableLookupTableInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, description, fields, primary_keys, *args, **kwargs):  # noqa: E501
        """ExportableLookupTableInfo - a model defined in OpenAPI
