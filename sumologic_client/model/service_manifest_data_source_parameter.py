...
class ServiceManifestDataSourceParameter(ModelNormal):
    ...
    validations = {
        ('parameter_type',): {
            'regex': {
                'pattern': r'^DATA_SOURCE$',  # noqa: E501
            },
        },
        ('data_source_type',): {
            'regex': {
                'pattern': r'^(LOG|METRICS)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'data_source_type': (str,),  # noqa: E501
            'label': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, parameter_type, parameter_id, *args, **kwargs):  # noqa: E501
        """ServiceManifestDataSourceParameter - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_source_type (str): Data source type.. [optional]  # noqa: E501
            label (str): Label.. [optional]  # noqa: E501
            description (str): Description.. [optional]  # noqa: E501
            example (str): Example.. [optional]  # noqa: E501
            hidden (bool): Should the UI display?. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, parameter_type, parameter_id, *args, **kwargs):  # noqa: E501
        """ServiceManifestDataSourceParameter - a model defined in OpenAPI
