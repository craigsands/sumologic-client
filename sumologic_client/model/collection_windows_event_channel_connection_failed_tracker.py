...
class CollectionWindowsEventChannelConnectionFailedTracker(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CollectionWindowsEventChannelConnectionFailedTracker - a model defined in OpenAPI
