...
def lazy_import():
    ...
    globals()['AlertsLibraryAlertExport'] = AlertsLibraryAlertExport
    globals()['AlertsLibraryFolderExport'] = AlertsLibraryFolderExport


class AlertsLibraryBaseExport(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AlertsLibraryAlertExport': AlertsLibraryAlertExport,
            'AlertsLibraryFolderExport': AlertsLibraryFolderExport,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, name, type, *args, **kwargs):  # noqa: E501
        """AlertsLibraryBaseExport - a model defined in OpenAPI
