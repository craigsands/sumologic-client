...
def lazy_import():
    ...
    globals()['IngestThrottlingTrackerAllOf'] = IngestThrottlingTrackerAllOf
    globals()['TrackerIdentity'] = TrackerIdentity


class IngestThrottlingTracker(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IngestThrottlingTracker - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_type (str): The type of data for which the rate limit was enabled. The possible values are `LogIngest` and `MetricsIngest`.. [optional]  # noqa: E501
        """
