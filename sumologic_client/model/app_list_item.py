...
def lazy_import():
    ...
    globals()['PanelItem'] = PanelItem


class AppListItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'query': (str,),  # noqa: E501
            'screenshot_url': (str,),  # noqa: E501
            'panels': ([PanelItem],),  # noqa: E501
            'children': ([AppListItem],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'screenshot_url': 'screenshotUrl',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item_type, name, *args, **kwargs):  # noqa: E501
        """AppListItem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the item.. [optional]  # noqa: E501
            query (str): Search query for the item. Applicable only for `Search`, `ScheduledSearch` and `MetricsSearch` itemType.. [optional]  # noqa: E501
            screenshot_url (str): URL for the screenshot of the item. Applicable only for `Dashboard` and `Report` itemType.. [optional]  # noqa: E501
            panels ([PanelItem]): Panels associated with the item. Applicable only for `Dashboard` and `Report` itemType.. [optional]  # noqa: E501
            children ([AppListItem]): Child content items. Applicable only for `Folder` itemType.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, item_type, name, *args, **kwargs):  # noqa: E501
        """AppListItem - a model defined in OpenAPI
