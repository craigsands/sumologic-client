...
class ResourceIdentities(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([ResourceIdentity],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ResourceIdentities - a model defined in OpenAPI

        Args:
            data ([ResourceIdentity]): A list of the resources.
