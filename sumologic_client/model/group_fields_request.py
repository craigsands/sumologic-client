...
class GroupFieldsRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, queries, monitor_type, *args, **kwargs):  # noqa: E501
        """GroupFieldsRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, queries, monitor_type, *args, **kwargs):  # noqa: E501
        """GroupFieldsRequest - a model defined in OpenAPI
