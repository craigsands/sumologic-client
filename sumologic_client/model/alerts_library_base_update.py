...
def lazy_import():
    ...
    globals()['AlertsLibraryAlertUpdate'] = AlertsLibraryAlertUpdate
    globals()['AlertsLibraryFolderUpdate'] = AlertsLibraryFolderUpdate


class AlertsLibraryBaseUpdate(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'AlertsLibraryAlertUpdate': AlertsLibraryAlertUpdate,
            'AlertsLibraryFolderUpdate': AlertsLibraryFolderUpdate,
        }
        if not val:
            return None
        return {'type': val}
    ...
    def _from_openapi_data(cls, name, version, type, *args, **kwargs):  # noqa: E501
        """AlertsLibraryBaseUpdate - a model defined in OpenAPI
