...
def lazy_import():
    ...
    globals()['MetricsSearchSyncDefinitionAllOf'] = MetricsSearchSyncDefinitionAllOf
    globals()['Query'] = Query
    globals()['ResolvableTimeRange'] = ResolvableTimeRange


class MetricsSearchSyncDefinition(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MetricsSearchSyncDefinition - a model defined in OpenAPI

        Keyword Args:
            time_range (ResolvableTimeRange):
            queries ([Query]): Queries of the metrics search page.
            ...
            description (str): Description of the metrics search page.. [optional]  # noqa: E501
            visual_settings (str): Visual settings of the metrics search page. Must be a string representing a valid JSON object. . [optional]  # noqa: E501
        """
