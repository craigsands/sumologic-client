...
def lazy_import():
    ...
    globals()['BuiltinFieldUsage'] = BuiltinFieldUsage


class ListBuiltinFieldsUsageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([BuiltinFieldUsage],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListBuiltinFieldsUsageResponse - a model defined in OpenAPI

        Args:
            data ([BuiltinFieldUsage]): List of fields with their usages.
