...
class LogsOutlier(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """LogsOutlier - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            window (int): Sets the trailing number of data points to calculate mean and sigma.. [optional] if omitted the server will use the default value of 10  # noqa: E501
