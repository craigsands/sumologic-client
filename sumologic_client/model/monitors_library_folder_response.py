...
def lazy_import():
    ...
    globals()['MonitorsLibraryFolderResponseAllOf'] = MonitorsLibraryFolderResponseAllOf


class MonitorsLibraryFolderResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'children': ([MonitorsLibraryBaseResponse],),  # noqa: E501
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryFolderResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            children ([MonitorsLibraryBaseResponse]): Children of the folder. NOTE: Permissions field will not be filled (empty list) for children.
