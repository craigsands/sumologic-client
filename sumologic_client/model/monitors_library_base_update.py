...
def lazy_import():
    ...
    globals()['MonitorsLibraryFolderUpdate'] = MonitorsLibraryFolderUpdate
    globals()['MonitorsLibraryMonitorUpdate'] = MonitorsLibraryMonitorUpdate


class MonitorsLibraryBaseUpdate(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'MonitorsLibraryFolderUpdate': MonitorsLibraryFolderUpdate,
            'MonitorsLibraryMonitorUpdate': MonitorsLibraryMonitorUpdate,
        }
        if not val:
            return None
        return {'type': val}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, version, type, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBaseUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, version, type, *args, **kwargs):  # noqa: E501
        """MonitorsLibraryBaseUpdate - a model defined in OpenAPI
