...
class NotificationThresholdSyncDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, threshold_type, operator, count, *args, **kwargs):  # noqa: E501
        """NotificationThresholdSyncDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, threshold_type, operator, count, *args, **kwargs):  # noqa: E501
        """NotificationThresholdSyncDefinition - a model defined in OpenAPI
