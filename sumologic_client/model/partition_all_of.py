...
class PartitionAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, total_bytes, *args, **kwargs):  # noqa: E501
        """PartitionAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, total_bytes, *args, **kwargs):  # noqa: E501
        """PartitionAllOf - a model defined in OpenAPI
