...
def lazy_import():
    ...
    globals()['SharedBucket'] = SharedBucket
...
class ContractDetails(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'shared_buckets': ([SharedBucket],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'contract_period': 'contractPeriod',  # noqa: E501
        'current_billing_period': 'currentBillingPeriod',  # noqa: E501
        'shared_buckets': 'sharedBuckets',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, plan_type, entitlements, contract_period, current_billing_period, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            entitlements ([Entitlements]): List of the entitlements of the account. Entitlements of the account are the list of products subscribed by the user.
        ...
        Keyword Args:
            ...
            shared_buckets ([SharedBucket]): Contains list of buckets. Bucket means shared pool from which multiple entitlements can use capacity.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, plan_type, entitlements, contract_period, current_billing_period, *args, **kwargs):  # noqa: E501
        """ContractDetails - a model defined in OpenAPI
