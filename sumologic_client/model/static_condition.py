...
def lazy_import():
    ...
    globals()['OccurrenceType'] = OccurrenceType
    globals()['StaticConditionAllOf'] = StaticConditionAllOf
    globals()['StaticThresholdType'] = StaticThresholdType
    globals()['TriggerCondition'] = TriggerCondition
    globals()['TriggerSource'] = TriggerSource


class StaticCondition(ModelComposed):
    ...
    validations = {
        ('trigger_type',): {
            'regex': {
                'pattern': r'^(Critical|Warning|MissingData|ResolvedCritical|ResolvedWarning|ResolvedMissingData)$',  # noqa: E501
            },
        },
        ('detection_method',): {
            'regex': {
                'pattern': r'^(StaticCondition|LogsStaticCondition|MetricsStaticCondition|LogsOutlierCondition|MetricsOutlierCondition|LogsMissingDataCondition|MetricsMissingDataCondition)$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'time_range': (str,),  # noqa: E501
            'occurrence_type': (OccurrenceType,),  # noqa: E501
            'trigger_source': (TriggerSource,),  # noqa: E501
            'trigger_type': (str,),  # noqa: E501
            'threshold': (float,),  # noqa: E501
            'threshold_type': (StaticThresholdType,),  # noqa: E501
            'field': (str,),  # noqa: E501
            'detection_method': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'threshold_type': 'thresholdType',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StaticCondition - a model defined in OpenAPI
