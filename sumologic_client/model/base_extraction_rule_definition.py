...
class BaseExtractionRuleDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, scope, parse_expression, *args, **kwargs):  # noqa: E501
        """BaseExtractionRuleDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, scope, parse_expression, *args, **kwargs):  # noqa: E501
        """BaseExtractionRuleDefinition - a model defined in OpenAPI
