...
class MetadataWithUserInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, created_by_user, modified_at, modified_by_user, *args, **kwargs):  # noqa: E501
        """MetadataWithUserInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, created_at, created_by_user, modified_at, modified_by_user, *args, **kwargs):  # noqa: E501
        """MetadataWithUserInfo - a model defined in OpenAPI
