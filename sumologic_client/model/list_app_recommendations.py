...
def lazy_import():
    ...
    globals()['AppRecommendation'] = AppRecommendation


class ListAppRecommendations(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ListAppRecommendations - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([AppRecommendation]): List of app recommendations.  # noqa: E501

        Keyword Args:
            value ([AppRecommendation]): List of app recommendations.  # noqa: E501
