...
class MetricsQuerySyncDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, query, row_id, *args, **kwargs):  # noqa: E501
        """MetricsQuerySyncDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, query, row_id, *args, **kwargs):  # noqa: E501
        """MetricsQuerySyncDefinition - a model defined in OpenAPI
