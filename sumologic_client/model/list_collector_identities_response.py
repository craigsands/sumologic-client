...
def lazy_import():
    ...
    globals()['CollectorIdentity'] = CollectorIdentity


class ListCollectorIdentitiesResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([CollectorIdentity],),  # noqa: E501
            'next': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListCollectorIdentitiesResponse - a model defined in OpenAPI

        Args:
            data ([CollectorIdentity]): List of Collector identities.
        ...
        Keyword Args:
            ...
            next (str): Next continuation token.. [optional]  # noqa: E501
        """
