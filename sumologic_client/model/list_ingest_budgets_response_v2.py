...
def lazy_import():
    ...
    globals()['IngestBudgetV2'] = IngestBudgetV2


class ListIngestBudgetsResponseV2(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListIngestBudgetsResponseV2 - a model defined in OpenAPI

        Args:
            data ([IngestBudgetV2]): List of ingest budgets.
