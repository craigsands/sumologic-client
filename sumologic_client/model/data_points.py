...
def lazy_import():
    ...
    globals()['BeginBoundedTimeRange'] = BeginBoundedTimeRange
    globals()['DataValue'] = DataValue


class DataPoints(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'time_range': (BeginBoundedTimeRange,),  # noqa: E501
            'values': ([DataValue],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time_range, *args, **kwargs):  # noqa: E501
        """DataPoints - a model defined in OpenAPI

        Args:
            time_range (BeginBoundedTimeRange):
        ...
        Keyword Args:
            ...
            values ([DataValue]): An array of objects denoting the value and unit of the data points.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, time_range, *args, **kwargs):  # noqa: E501
        """DataPoints - a model defined in OpenAPI
