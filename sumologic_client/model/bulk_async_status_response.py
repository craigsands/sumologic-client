...
def lazy_import():
    ...
    globals()['AsyncJobStatus'] = AsyncJobStatus
    globals()['BulkErrorResponse'] = BulkErrorResponse


class BulkAsyncStatusResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'job_statuses': ({str: (AsyncJobStatus,)},),  # noqa: E501
            'errors': ({str: (BulkErrorResponse,)},),  # noqa: E501
        }
    ...
    attribute_map = {
        'job_statuses': 'jobStatuses',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, job_statuses, errors, *args, **kwargs):  # noqa: E501
        """BulkAsyncStatusResponse - a model defined in OpenAPI

        Args:
            job_statuses ({str: (AsyncJobStatus,)}): Map of job identifiers to job statuses.
            errors ({str: (BulkErrorResponse,)}): Map of content identifiers to error messages for all failed job requests
    ...
    @convert_js_args_to_python_args
    def __init__(self, job_statuses, errors, *args, **kwargs):  # noqa: E501
        """BulkAsyncStatusResponse - a model defined in OpenAPI
