...
class ContainerPanelAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, layout, panels, *args, **kwargs):  # noqa: E501
        """ContainerPanelAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, layout, panels, *args, **kwargs):  # noqa: E501
        """ContainerPanelAllOf - a model defined in OpenAPI
