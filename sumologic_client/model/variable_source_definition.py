...
def lazy_import():
    ...
    globals()['CsvVariableSourceDefinition'] = CsvVariableSourceDefinition
    globals()['LogQueryVariableSourceDefinition'] = LogQueryVariableSourceDefinition
    globals()['MetadataVariableSourceDefinition'] = MetadataVariableSourceDefinition


class VariableSourceDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'variable_source_type': (str,),  # noqa: E501
        }
    ...
    def discriminator():
        ...
        if not val:
            return None
        return {'variable_source_type': val}

    attribute_map = {
        'variable_source_type': 'variableSourceType',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, variable_source_type, *args, **kwargs):  # noqa: E501
        """VariableSourceDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, variable_source_type, *args, **kwargs):  # noqa: E501
        """VariableSourceDefinition - a model defined in OpenAPI
