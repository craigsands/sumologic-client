...
def lazy_import():
    ...
    globals()['AlertChartMetadata'] = AlertChartMetadata
    globals()['SeriesData'] = SeriesData


class AlertChartDataResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'series': ([SeriesData],),  # noqa: E501
            'metadata': (AlertChartMetadata,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, series, metadata, *args, **kwargs):  # noqa: E501
        """AlertChartDataResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, series, metadata, *args, **kwargs):  # noqa: E501
        """AlertChartDataResult - a model defined in OpenAPI
