...
def lazy_import():
    ...
    globals()['ReportAction'] = ReportAction
    globals()['Template'] = Template


class GenerateReportRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'action': (ReportAction,),  # noqa: E501
            'export_format': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'export_format': 'exportFormat',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, export_format, timezone, template, *args, **kwargs):  # noqa: E501
        """GenerateReportRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, export_format, timezone, template, *args, **kwargs):  # noqa: E501
        """GenerateReportRequest - a model defined in OpenAPI
