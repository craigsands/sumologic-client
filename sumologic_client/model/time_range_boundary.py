...
def lazy_import():
    ...
    globals()['EpochTimeRangeBoundary'] = EpochTimeRangeBoundary
    globals()['Iso8601TimeRangeBoundary'] = Iso8601TimeRangeBoundary
    globals()['LiteralTimeRangeBoundary'] = LiteralTimeRangeBoundary
    globals()['RelativeTimeRangeBoundary'] = RelativeTimeRangeBoundary


class TimeRangeBoundary(ModelNormal):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """TimeRangeBoundary - a model defined in OpenAPI
