...
class PermissionSubject(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, subject_type, subject_id, *args, **kwargs):  # noqa: E501
        """PermissionSubject - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, subject_type, subject_id, *args, **kwargs):  # noqa: E501
        """PermissionSubject - a model defined in OpenAPI
