...
def lazy_import():
    ...
    globals()['OutlierSeriesDataPoint'] = OutlierSeriesDataPoint
    globals()['StaticSeriesDataPoint'] = StaticSeriesDataPoint
...
class DataPoint(ModelNormal):
    ...
    def discriminator():
        lazy_import()
        val = {
            'OutlierSeriesDataPoint': OutlierSeriesDataPoint,
            'StaticSeriesDataPoint': StaticSeriesDataPoint,
        }
        if not val:
            return None
