...
def lazy_import():
    ...
    globals()['ArchiveJob'] = ArchiveJob


class ListArchiveJobsResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """ListArchiveJobsResponse - a model defined in OpenAPI

        Args:
            data ([ArchiveJob]): List of Archive Jobs.
