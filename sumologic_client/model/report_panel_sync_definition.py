...
def lazy_import():
    ...
    globals()['MetricsQuerySyncDefinition'] = MetricsQuerySyncDefinition
    globals()['QueryParameterSyncDefinition'] = QueryParameterSyncDefinition
    globals()['ReportAutoParsingInfo'] = ReportAutoParsingInfo
    globals()['ResolvableTimeRange'] = ResolvableTimeRange


class ReportPanelSyncDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'viewer_type': (str,),  # noqa: E501
            'detail_level': (int,),  # noqa: E501
            'query_string': (str,),  # noqa: E501
            'metrics_queries': ([MetricsQuerySyncDefinition],),  # noqa: E501
            ...
            'id': (str,),  # noqa: E501
            'query_parameters': ([QueryParameterSyncDefinition],),  # noqa: E501
            'desired_quantization_in_secs': (int,),  # noqa: E501
            'auto_parsing_info': (ReportAutoParsingInfo,),  # noqa: E501
        }
    ...
    attribute_map = {
        'name': 'name',  # noqa: E501
        'viewer_type': 'viewerType',  # noqa: E501
        'detail_level': 'detailLevel',  # noqa: E501
        'query_string': 'queryString',  # noqa: E501
        'metrics_queries': 'metricsQueries',  # noqa: E501
        ...
        'desired_quantization_in_secs': 'desiredQuantizationInSecs',  # noqa: E501
        'auto_parsing_info': 'autoParsingInfo',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, viewer_type, detail_level, query_string, metrics_queries, time_range, x, y, width, height, properties, id, query_parameters, *args, **kwargs):  # noqa: E501
        """ReportPanelSyncDefinition - a model defined in OpenAPI
        ...
        Args:
            ...
            metrics_queries ([MetricsQuerySyncDefinition]): The query or queries to run, for panels associated to metrics searches.
            ...
            query_parameters ([QueryParameterSyncDefinition]): The parameters for parameterized searches.
        ...
        Keyword Args:
            ...
            desired_quantization_in_secs (int): The quantization interval aligns your time series data to common intervals on the time axis (for example every one minute) to optimize the visualization and performance.. [optional]  # noqa: E501
            auto_parsing_info (ReportAutoParsingInfo): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, viewer_type, detail_level, query_string, metrics_queries, time_range, x, y, width, height, properties, id, query_parameters, *args, **kwargs):  # noqa: E501
        """ReportPanelSyncDefinition - a model defined in OpenAPI
