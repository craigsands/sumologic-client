...
def lazy_import():
    ...
    globals()['CapabilityDefinitionGroup'] = CapabilityDefinitionGroup


class CapabilityDefinition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'label': (str,),  # noqa: E501
            'depends_on': ([str],),  # noqa: E501
            'group': (CapabilityDefinitionGroup,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, label, depends_on, group, *args, **kwargs):  # noqa: E501
        """CapabilityDefinition - a model defined in OpenAPI
        ...
        Args:
            ...
            group (CapabilityDefinitionGroup):
        ...
        Keyword Args:
            ...
            message (str): Warning message that appears when this capability is enabled.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, label, depends_on, group, *args, **kwargs):  # noqa: E501
        """CapabilityDefinition - a model defined in OpenAPI
