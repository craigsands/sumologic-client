...
from sumologic_client import rest
from sumologic_client.configuration import Configuration
from sumologic_client.exceptions import ApiTypeError, ApiValueError, ApiException
from sumologic_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AccessKeyManagementApi()
        api_instance.create_access_key  # this is an instance of the class Endpoint
        api_instance.create_access_key()  # this invokes api_instance.create_access_key.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_access_key.callable or self.callable in this class
